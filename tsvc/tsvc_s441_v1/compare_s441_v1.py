...
if __name__ == "__main__":
    ...
    for size in sizes:
        ...
        for comp, c_comp in compilers:
            ...
            for rep in range(N_rep):
                ...
                results.append((size, c_comp, "vec", rep, t_vec))

                # Non-vectorized C++
                a_novec = a_init.copy()
                t_novec = run_s441_v1(lib_novec, a_novec, b, c, d)
                results.append((size, c_comp, "novec", rep, t_novec))
    ...
    csv_path = "s441_v1_benchmark_results_repeated.csv"
