...
paths = [
    ...
    #("gcc",  "arm", "gcc/arm/cloudsc_pattern_1_timings.csv"),
    ...
    #("llvm", "arm", "llvm/arm/cloudsc_pattern_1_timings.csv"),
]

for l, k, v in [("w_cpy", "cloudsc_pattern_1_vectorized_static_veclen_8_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
             ("no_cpy", "cloudsc_pattern_1_vectorized_static_veclen_8_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:
    ...
    # SDFGs to include
    # ------------------------
    alt_name = base_name + k[len("cloudsc_pattern_1"):]
    ...
    color_map = {
    'cloudsc_pattern_1': colors[1],
    'cloudsc_pattern_1_vectorized_static_veclen_8_no_cpy': colors[1],
    'cloudsc_pattern_1_vectorized_static_veclen_8_cpy': colors[2],
    'cloudsc_pattern_1_vectorized_static_veclen_16_no_cpy': colors[3],
