...
# S = dace.symbol("S")
flags = "-mcpu=native -march=native --target=aarch64-linux-gnu -fopenmp -std=c++17 -faligned-new -fPIC -Wall -Wextra -O3 -ffast-math -Wno-unused-parameter -Wno-unused-label" 
