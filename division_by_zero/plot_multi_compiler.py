...
for vl in [8, 16, 32, 64]:
    for l, k, v in [("w_cpy", f"division_by_zero_dace_veclen_{vl}_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
                ("no_cpy", f"division_by_zero_dace_veclen_{vl}_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:
        ...
        f'division_by_zero_dace_veclen_{vl}_no_cpy': colors[1],
        f'division_by_zero_dace_veclen_{vl}_cpy': colors[2],
        }
