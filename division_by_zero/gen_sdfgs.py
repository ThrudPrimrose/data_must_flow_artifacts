...
if __name__ == "__main__":
    ...
    division_by_zero_sdfg_vectorized.name = "division_by_zero_vectorized"
    VectorizeCPU(vector_width=8, insert_copies=True, fuse_overlapping_loads=True).apply_pass(division_by_zero_sdfg_vectorized, {})
    division_by_zero_sdfg_vectorized.save("division_by_zero_vectorized.sdfgz", compress=True)