...
if __name__ == "__main__":
    ...
    jacobi2d_sdfg_vectorized4 = jacobi2d.to_sdfg()
    jacobi2d_sdfg_vectorized4.name = "jacobi2d_vectorized"
    VectorizeCPU(
    ...
    jacobi2d_sdfg.compile()
    jacobi2d_sdfg_vectorized4.compile()

    jacobi2d_sdfg_vectorized5 = jacobi2d.to_sdfg()
    jacobi2d_sdfg_vectorized5.name = "jacobi2d_vectorized_cpy"
    VectorizeCPU(
        vector_width=8, insert_copies=True, fuse_overlapping_loads=False
    ).apply_pass(jacobi2d_sdfg_vectorized5, {})
    jacobi2d_sdfg_vectorized5.save(
        "jacobi2d_vectorized_static_veclen_8_cpy.sdfgz", compress=True
    )
    jacobi2d_sdfg_vectorized5.compile()
