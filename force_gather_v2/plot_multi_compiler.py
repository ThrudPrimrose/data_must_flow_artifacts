...
# ------------------------
paths = [
    ("gcc",  "amd_epyc",   "gcc/amd_epyc/load_store_benchmarks_timings_1_core.csv"),
    ("gcc",  "intel_xeon", "gcc/intel_xeon/load_store_benchmarks_timings_1_core.csv"),
    #("gcc",  "arm", "gcc/arm/load_store_benchmarks_timings.csv"),
    ("llvm", "amd_epyc",   "llvm/amd_epyc/load_store_benchmarks_timings_1_core.csv"),
    ("llvm", "intel_xeon", "llvm/intel_xeon/load_store_benchmarks_timings_1_core.csv"),
    #("llvm", "arm", "llvm/arm/load_store_benchmarks_timings.csv"),
]

for l, k, v in [("w_cpy", "load_store_benchmarks_vectorized_static_veclen_8_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
             ("no_cpy", "load_store_benchmarks_vectorized_static_veclen_8_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:


    label_map = {
        "load_store_benchmarks": "Auto Vectorized",
        k: v, 
    }
    ...
    # SDFGs to include
    # ------------------------
    alt_name = base_name + k[len("load_store_benchmarks"):]
    ...
    color_map = {
    'load_store_benchmarks_std': colors[0],
    'load_store_benchmarks_std_vectorized_static_veclen_8_no_cpy': colors[1],
    'load_store_benchmarks_std_vectorized_static_veclen_8_cpy': colors[2],
    'load_store_benchmarks_std_vectorized_static_veclen_16_no_cpy': colors[3],
    'load_store_benchmarks_std_vectorized_static_veclen_16_cpy': colors[4],
    'load_store_benchmarks_std_vectorized_static_veclen_32_no_cpy': colors[5],
    'load_store_benchmarks_std_vectorized_static_veclen_32_cpy': colors[6],
    'load_store_benchmarks_dace_vectorized_static_veclen_8_no_cpy': colors[7],
    'load_store_benchmarks_dace_vectorized_static_veclen_8_cpy': colors[8],
    'load_store_benchmarks_dace_vectorized_static_veclen_16_no_cpy': colors[9],
    'load_store_benchmarks_dace_vectorized_static_veclen_16_cpy': colors[10],
    'load_store_benchmarks_dace_vectorized_static_veclen_32_no_cpy': colors[11],
    'load_store_benchmarks_dace_vectorized_static_veclen_32_cpy': colors[12],
    }
