...
# ------------------------
paths = [
    ("gcc",  "amd_epyc",   "gcc/amd_epyc/exp_implementations_timings_1_core.csv"),
    ("gcc",  "intel_xeon", "gcc/intel_xeon/exp_implementations_timings_1_core.csv"),
    #("gcc",  "arm", "gcc/arm/exp_implementations_timings.csv"),
    ("llvm", "amd_epyc",   "llvm/amd_epyc/exp_implementations_timings_1_core.csv"),
    ("llvm", "intel_xeon", "llvm/intel_xeon/exp_implementations_timings_1_core.csv"),
    #("llvm", "arm", "llvm/arm/exp_implementations_timings.csv"),
]

for l, k, v in [("w_cpy", "exp_implementations_vectorized_static_veclen_8_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
             ("no_cpy", "exp_implementations_vectorized_static_veclen_8_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:


    label_map = {
        "exp_implementations": "Auto Vectorized",
        k: v, 
    }
    ...
    # SDFGs to include
    # ------------------------
    alt_name = base_name + k[len("exp_implementations"):]
    ...
    color_map = {
    'exp_implementations_std': colors[0],
    'exp_implementations_std_vectorized_static_veclen_8_no_cpy': colors[1],
    'exp_implementations_std_vectorized_static_veclen_8_cpy': colors[2],
    'exp_implementations_std_vectorized_static_veclen_16_no_cpy': colors[3],
    'exp_implementations_std_vectorized_static_veclen_16_cpy': colors[4],
    'exp_implementations_std_vectorized_static_veclen_32_no_cpy': colors[5],
    'exp_implementations_std_vectorized_static_veclen_32_cpy': colors[6],
    'exp_implementations_dace_vectorized_static_veclen_8_no_cpy': colors[7],
    'exp_implementations_dace_vectorized_static_veclen_8_cpy': colors[8],
    'exp_implementations_dace_vectorized_static_veclen_16_no_cpy': colors[9],
    'exp_implementations_dace_vectorized_static_veclen_16_cpy': colors[10],
    'exp_implementations_dace_vectorized_static_veclen_32_no_cpy': colors[11],
    'exp_implementations_dace_vectorized_static_veclen_32_cpy': colors[12],
    }
