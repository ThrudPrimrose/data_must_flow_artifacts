...
0000000000001a00 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d@plt>:
    1a00:	ff 25 fa 26 20 00    	jmpq   *0x2026fa(%rip)        # 204100 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d@@Base+0x2024f0>
...
0000000000001c10 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d>:
    1c10:	41 57                	push   %r15
    1c12:	41 56                	push   %r14
    1c14:	53                   	push   %rbx
    ...
    1c50:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1d40 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1c8c:	74 07                	je     1c95 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d+0x85>
    1c8e:	e8 ed fc ff ff       	callq  1980 <pthread_self@plt>
    1c93:	eb 05                	jmp    1c9a <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d+0x8a>
    ...
    1cec:	48 8d 35 a0 14 00 00 	lea    0x14a0(%rip),%rsi        # 3193 <_fini+0x1c7>
    1cf3:	48 8d 15 bf 14 00 00 	lea    0x14bf(%rip),%rdx        # 31b9 <_fini+0x1ed>
    ...
    1d10:	48 8d 35 a8 14 00 00 	lea    0x14a8(%rip),%rsi        # 31bf <_fini+0x1f3>
    1d17:	48 8d 15 d2 14 00 00 	lea    0x14d2(%rip),%rdx        # 31f0 <_fini+0x224>
    ...
    1d30:	e8 7b 02 00 00       	callq  1fb0 <__clang_call_terminate>
    1d35:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d3c:	00 00 00 00 

0000000000001d40 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined>:
    1d40:	55                   	push   %rbp
    1d41:	41 57                	push   %r15
    1d43:	41 56                	push   %r14
    1d45:	53                   	push   %rbx
    ...
    1d5c:	00 
    1d5d:	c7 44 24 08 ff ff 23 	movl   $0x23ffff,0x8(%rsp)
    1d64:	00 
    ...
    1db2:	b8 ff ff 23 00       	mov    $0x23ffff,%eax
    1db7:	81 f9 ff ff 23 00    	cmp    $0x23ffff,%ecx
    1dbd:	0f 4c c1             	cmovl  %ecx,%eax
    1dc0:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1dc4:	39 c6                	cmp    %eax,%esi
    1dc6:	0f 8f 9c 00 00 00    	jg     1e68 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined+0x128>
    1dcc:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
    1dd1:	48 89 f2             	mov    %rsi,%rdx
    1dd4:	29 f0                	sub    %esi,%eax
    1dd6:	48 c1 e2 07          	shl    $0x7,%rdx
    1dda:	ff c0                	inc    %eax
    1ddc:	0f 1f 40 00          	nopl   0x0(%rax)
    1de0:	49 8b 3e             	mov    (%r14),%rdi
    1de3:	49 8b 37             	mov    (%r15),%rsi
    1de6:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1dea:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1dee:	c5 e1 57 db          	vxorpd %xmm3,%xmm3,%xmm3
    1df2:	c5 d9 57 e4          	vxorpd %xmm4,%xmm4,%xmm4
    1df6:	c5 d1 57 ed          	vxorpd %xmm5,%xmm5,%xmm5
    1dfa:	c5 f8 10 04 17       	vmovups (%rdi,%rdx,1),%xmm0
    1dff:	c5 f8 c6 44 17 10 88 	vshufps $0x88,0x10(%rdi,%rdx,1),%xmm0,%xmm0
    1e06:	c4 e2 f5 92 14 86    	vgatherdpd %ymm1,(%rsi,%xmm0,4),%ymm2
    1e0c:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e10:	c4 e2 f5 92 5c 86 20 	vgatherdpd %ymm1,0x20(%rsi,%xmm0,4),%ymm3
    1e17:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e1b:	c4 e2 f5 92 64 86 40 	vgatherdpd %ymm1,0x40(%rsi,%xmm0,4),%ymm4
    1e22:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e26:	c4 e2 f5 92 6c 86 60 	vgatherdpd %ymm1,0x60(%rsi,%xmm0,4),%ymm5
    1e2d:	c4 e2 7d 19 03       	vbroadcastsd (%rbx),%ymm0
    1e32:	48 8b 31             	mov    (%rcx),%rsi
    1e35:	c5 fd 59 ca          	vmulpd %ymm2,%ymm0,%ymm1
    1e39:	c5 fd 11 0c 16       	vmovupd %ymm1,(%rsi,%rdx,1)
    1e3e:	c5 fd 59 cb          	vmulpd %ymm3,%ymm0,%ymm1
    1e42:	c5 fd 11 4c 16 20    	vmovupd %ymm1,0x20(%rsi,%rdx,1)
    1e48:	c5 fd 59 cc          	vmulpd %ymm4,%ymm0,%ymm1
    1e4c:	c5 fd 11 4c 16 40    	vmovupd %ymm1,0x40(%rsi,%rdx,1)
    1e52:	c5 d5 59 c0          	vmulpd %ymm0,%ymm5,%ymm0
    1e56:	c5 fd 11 44 16 60    	vmovupd %ymm0,0x60(%rsi,%rdx,1)
    1e5c:	48 83 ea 80          	sub    $0xffffffffffffff80,%rdx
    1e60:	ff c8                	dec    %eax
    1e62:	0f 85 78 ff ff ff    	jne    1de0 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined+0xa0>
    1e68:	48 8d 3d f1 1e 20 00 	lea    0x201ef1(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1e6f:	89 ee                	mov    %ebp,%esi
    1e71:	c5 f8 77             	vzeroupper 
    1e74:	e8 c7 f9 ff ff       	callq  1840 <__kmpc_for_static_fini@plt>
    1e79:	48 83 c4 18          	add    $0x18,%rsp
    1e7d:	5b                   	pop    %rbx
    1e7e:	41 5e                	pop    %r14
    1e80:	41 5f                	pop    %r15
    1e82:	5d                   	pop    %rbp
    1e83:	c3                   	retq   
    1e84:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1e8b:	00 00 00 00 00 

0000000000001e90 <__program_gather_load_static_veclen_16_cpy>:
    1e90:	e9 6b fb ff ff       	jmpq   1a00 <_Z51__program_gather_load_static_veclen_16_cpy_internalP40gather_load_static_veclen_16_cpy_state_tPdPlS1_d@plt>
    1e95:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1e9c:	00 00 00 00 

0000000000001ea0 <__dace_init_gather_load_static_veclen_16_cpy>:
    1ea0:	50                   	push   %rax
...
0000000000001ec0 <__dace_exit_gather_load_static_veclen_16_cpy>:
    1ec0:	48 85 ff             	test   %rdi,%rdi
    1ec3:	74 23                	je     1ee8 <__dace_exit_gather_load_static_veclen_16_cpy+0x28>
    1ec5:	53                   	push   %rbx
    1ec6:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1eca:	48 85 c0             	test   %rax,%rax
    1ecd:	74 0e                	je     1edd <__dace_exit_gather_load_static_veclen_16_cpy+0x1d>
...
0000000000001fc0 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    205f:	48 8d 35 cb 11 00 00 	lea    0x11cb(%rip),%rsi        # 3231 <_fini+0x265>
    ...
    2073:	48 8d 35 b9 11 00 00 	lea    0x11b9(%rip),%rsi        # 3233 <_fini+0x267>
    ...
    20a0:	48 8d 35 94 11 00 00 	lea    0x1194(%rip),%rsi        # 323b <_fini+0x26f>
    ...
    21c2:	48 8d 35 8f 10 00 00 	lea    0x108f(%rip),%rsi        # 3258 <_fini+0x28c>
    ...
    222e:	48 8d 35 0c 10 00 00 	lea    0x100c(%rip),%rsi        # 3241 <_fini+0x275>
    ...
    22b6:	48 8d 1d a7 0f 00 00 	lea    0xfa7(%rip),%rbx        # 3264 <_fini+0x298>
    22bd:	4c 8d 3d a1 0f 00 00 	lea    0xfa1(%rip),%r15        # 3265 <_fini+0x299>
    ...
    22dc:	48 8d 35 ec 0f 00 00 	lea    0xfec(%rip),%rsi        # 32cf <_fini+0x303>
    ...
    2341:	48 8d 35 0c 0f 00 00 	lea    0xf0c(%rip),%rsi        # 3254 <_fini+0x288>
    ...
    2355:	48 8d 35 fe 0e 00 00 	lea    0xefe(%rip),%rsi        # 325a <_fini+0x28e>
    ...
    2393:	48 8d 35 ce 0e 00 00 	lea    0xece(%rip),%rsi        # 3268 <_fini+0x29c>
    ...
    23d1:	48 8d 35 99 0e 00 00 	lea    0xe99(%rip),%rsi        # 3271 <_fini+0x2a5>
    ...
    2410:	48 8d 35 62 0e 00 00 	lea    0xe62(%rip),%rsi        # 3279 <_fini+0x2ad>
    ...
    2447:	48 8d 35 32 0e 00 00 	lea    0xe32(%rip),%rsi        # 3280 <_fini+0x2b4>
    ...
    247b:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 3288 <_fini+0x2bc>
    ...
    24ab:	48 8d 35 de 0d 00 00 	lea    0xdde(%rip),%rsi        # 3290 <_fini+0x2c4>
    ...
    24db:	48 8d 35 b6 0d 00 00 	lea    0xdb6(%rip),%rsi        # 3298 <_fini+0x2cc>
    ...
    24ef:	48 8d 35 ac 0d 00 00 	lea    0xdac(%rip),%rsi        # 32a2 <_fini+0x2d6>
    ...
    2516:	48 8d 35 90 0d 00 00 	lea    0xd90(%rip),%rsi        # 32ad <_fini+0x2e1>
    ...
    253d:	48 8d 35 78 0d 00 00 	lea    0xd78(%rip),%rsi        # 32bc <_fini+0x2f0>
    ...
    2564:	48 8d 35 5a 0d 00 00 	lea    0xd5a(%rip),%rsi        # 32c5 <_fini+0x2f9>
    ...
    2592:	48 8d 35 28 0d 00 00 	lea    0xd28(%rip),%rsi        # 32c1 <_fini+0x2f5>
    ...
    25b5:	48 8d 35 0d 0d 00 00 	lea    0xd0d(%rip),%rsi        # 32c9 <_fini+0x2fd>
    ...
    2629:	48 8d 35 9c 0c 00 00 	lea    0xc9c(%rip),%rsi        # 32cc <_fini+0x300>
    ...
    268f:	48 8d 35 3b 0c 00 00 	lea    0xc3b(%rip),%rsi        # 32d1 <_fini+0x305>
    ...
    26de:	48 8d 35 e2 0b 00 00 	lea    0xbe2(%rip),%rsi        # 32c7 <_fini+0x2fb>
    ...
    2745:	48 8d 35 7e 0b 00 00 	lea    0xb7e(%rip),%rsi        # 32ca <_fini+0x2fe>
    ...
    28fd:	48 8d 3d f6 09 00 00 	lea    0x9f6(%rip),%rdi        # 32fa <_fini+0x32e>
...
0000000000002c10 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2e63:	48 8d 3d 77 04 00 00 	lea    0x477(%rip),%rdi        # 32e1 <_fini+0x315>
...
0000000000002e70 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    2fbf:	48 8d 3d 34 03 00 00 	lea    0x334(%rip),%rdi        # 32fa <_fini+0x32e>
