...
00000000000018d0 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d@plt>:
    18d0:	ff 25 92 27 20 00    	jmpq   *0x202792(%rip)        # 204068 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d@@Base+0x202458>
...
0000000000001c10 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d>:
    1c10:	41 57                	push   %r15
    1c12:	41 56                	push   %r14
    1c14:	53                   	push   %rbx
    ...
    1c50:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1d40 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1c8c:	74 07                	je     1c95 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d+0x85>
    1c8e:	e8 fd fc ff ff       	callq  1990 <pthread_self@plt>
    1c93:	eb 05                	jmp    1c9a <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d+0x8a>
    ...
    1cec:	48 8d 35 26 15 00 00 	lea    0x1526(%rip),%rsi        # 3219 <_fini+0x1cd>
    1cf3:	48 8d 15 46 15 00 00 	lea    0x1546(%rip),%rdx        # 3240 <_fini+0x1f4>
    ...
    1d10:	48 8d 35 2f 15 00 00 	lea    0x152f(%rip),%rsi        # 3246 <_fini+0x1fa>
    1d17:	48 8d 15 5a 15 00 00 	lea    0x155a(%rip),%rdx        # 3278 <_fini+0x22c>
    ...
    1d30:	e8 fb 02 00 00       	callq  2030 <__clang_call_terminate>
    1d35:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d3c:	00 00 00 00 

0000000000001d40 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined>:
    1d40:	55                   	push   %rbp
    ...
    1d51:	48 81 ec 80 18 00 00 	sub    $0x1880,%rsp
    1d58:	8b 37                	mov    (%rdi),%esi
    1d5a:	49 89 cf             	mov    %rcx,%r15
    1d5d:	4c 89 4c 24 38       	mov    %r9,0x38(%rsp)
    1d62:	4c 89 44 24 30       	mov    %r8,0x30(%rsp)
    1d67:	c7 44 24 20 00 00 00 	movl   $0x0,0x20(%rsp)
    1d6e:	00 
    1d6f:	c7 44 24 1c ff 3f 02 	movl   $0x23fff,0x1c(%rsp)
    1d76:	00 
    1d77:	c7 44 24 2c 01 00 00 	movl   $0x1,0x2c(%rsp)
    1d7e:	00 
    1d7f:	c7 44 24 28 00 00 00 	movl   $0x0,0x28(%rsp)
    1d86:	00 
    1d87:	48 83 ec 08          	sub    $0x8,%rsp
    1d8b:	48 8d 44 24 34       	lea    0x34(%rsp),%rax
    1d90:	48 8d 3d b1 1f 20 00 	lea    0x201fb1(%rip),%rdi        # 203d48 <__dso_handle+0x8>
    1d97:	48 8d 4c 24 30       	lea    0x30(%rsp),%rcx
    1d9c:	4c 8d 44 24 28       	lea    0x28(%rsp),%r8
    1da1:	4c 8d 4c 24 24       	lea    0x24(%rsp),%r9
    1da6:	89 74 24 2c          	mov    %esi,0x2c(%rsp)
    1daa:	ba 22 00 00 00       	mov    $0x22,%edx
    1daf:	6a 01                	pushq  $0x1
    1db1:	6a 01                	pushq  $0x1
    1db3:	50                   	push   %rax
    1db4:	e8 b7 fc ff ff       	callq  1a70 <__kmpc_for_static_init_4@plt>
    1db9:	48 83 c4 20          	add    $0x20,%rsp
    1dbd:	8b 44 24 1c          	mov    0x1c(%rsp),%eax
    1dc1:	4c 63 74 24 20       	movslq 0x20(%rsp),%r14
    1dc6:	bb ff 3f 02 00       	mov    $0x23fff,%ebx
    1dcb:	3d ff 3f 02 00       	cmp    $0x23fff,%eax
    1dd0:	0f 4c d8             	cmovl  %eax,%ebx
    1dd3:	89 5c 24 1c          	mov    %ebx,0x1c(%rsp)
    1dd7:	41 39 de             	cmp    %ebx,%r14d
    1dda:	0f 8f 06 01 00 00    	jg     1ee6 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined+0x1a6>
    1de0:	ff c3                	inc    %ebx
    1de2:	4c 8d ac 24 40 10 00 	lea    0x1040(%rsp),%r13
    1de9:	00 
    1dea:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1df0:	48 8b 4c 24 30       	mov    0x30(%rsp),%rcx
    1df5:	4c 89 f2             	mov    %r14,%rdx
    1df8:	49 8b 07             	mov    (%r15),%rax
    1dfb:	4d 89 f4             	mov    %r14,%r12
    1dfe:	48 c1 e2 0b          	shl    $0xb,%rdx
    1e02:	49 c1 e4 08          	shl    $0x8,%r12
    1e06:	48 8b 09             	mov    (%rcx),%rcx
    1e09:	c5 f8 10 04 11       	vmovups (%rcx,%rdx,1),%xmm0
    1e0e:	c5 f8 c6 44 11 10 88 	vshufps $0x88,0x10(%rcx,%rdx,1),%xmm0,%xmm0
    1e15:	48 c7 c1 fc ff ff ff 	mov    $0xfffffffffffffffc,%rcx
    1e1c:	0f 1f 40 00          	nopl   0x0(%rax)
    1e20:	c5 f1 57 c9          	vxorpd %xmm1,%xmm1,%xmm1
    1e24:	c5 ed 76 d2          	vpcmpeqd %ymm2,%ymm2,%ymm2
    1e28:	c4 e2 ed 92 0c 80    	vgatherdpd %ymm2,(%rax,%xmm0,4),%ymm1
    1e2e:	48 83 c0 20          	add    $0x20,%rax
    1e32:	c5 fd 29 4c cc 60    	vmovapd %ymm1,0x60(%rsp,%rcx,8)
    1e38:	48 83 c1 04          	add    $0x4,%rcx
    1e3c:	48 81 f9 fc 00 00 00 	cmp    $0xfc,%rcx
    1e43:	72 db                	jb     1e20 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined+0xe0>
    1e45:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1e4a:	c4 e2 7d 19 00       	vbroadcastsd (%rax),%ymm0
    1e4f:	b8 0c 00 00 00       	mov    $0xc,%eax
    1e54:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1e5b:	00 00 00 00 00 
    1e60:	c5 fd 59 4c c4 e0    	vmulpd -0x20(%rsp,%rax,8),%ymm0,%ymm1
    1e66:	c5 fd 59 14 c4       	vmulpd (%rsp,%rax,8),%ymm0,%ymm2
    1e6b:	c5 fd 59 5c c4 20    	vmulpd 0x20(%rsp,%rax,8),%ymm0,%ymm3
    1e71:	c5 fd 59 64 c4 40    	vmulpd 0x40(%rsp,%rax,8),%ymm0,%ymm4
    1e77:	c5 fd 29 8c c4 e0 07 	vmovapd %ymm1,0x7e0(%rsp,%rax,8)
    1e7e:	00 00 
    1e80:	c5 fd 29 94 c4 00 08 	vmovapd %ymm2,0x800(%rsp,%rax,8)
    1e87:	00 00 
    1e89:	c5 fd 29 9c c4 20 08 	vmovapd %ymm3,0x820(%rsp,%rax,8)
    1e90:	00 00 
    1e92:	c5 fd 29 a4 c4 40 08 	vmovapd %ymm4,0x840(%rsp,%rax,8)
    1e99:	00 00 
    1e9b:	48 83 c0 10          	add    $0x10,%rax
    1e9f:	48 3d 0c 01 00 00    	cmp    $0x10c,%rax
    1ea5:	75 b9                	jne    1e60 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined+0x120>
    1ea7:	ba 00 08 00 00       	mov    $0x800,%edx
    1eac:	4c 89 ef             	mov    %r13,%rdi
    1eaf:	48 8d b4 24 40 08 00 	lea    0x840(%rsp),%rsi
    1eb6:	00 
    1eb7:	c5 f8 77             	vzeroupper 
    1eba:	e8 b1 fa ff ff       	callq  1970 <memcpy@plt>
    1ebf:	48 8b 45 10          	mov    0x10(%rbp),%rax
    1ec3:	49 c1 e4 03          	shl    $0x3,%r12
    1ec7:	ba 00 08 00 00       	mov    $0x800,%edx
    1ecc:	4c 89 ee             	mov    %r13,%rsi
    1ecf:	4c 03 20             	add    (%rax),%r12
    1ed2:	4c 89 e7             	mov    %r12,%rdi
    1ed5:	e8 96 fa ff ff       	callq  1970 <memcpy@plt>
    1eda:	49 ff c6             	inc    %r14
    1edd:	44 39 f3             	cmp    %r14d,%ebx
    1ee0:	0f 85 0a ff ff ff    	jne    1df0 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d.omp_outlined+0xb0>
    1ee6:	8b 74 24 24          	mov    0x24(%rsp),%esi
    1eea:	48 8d 3d 6f 1e 20 00 	lea    0x201e6f(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1ef1:	e8 4a f9 ff ff       	callq  1840 <__kmpc_for_static_fini@plt>
    1ef6:	48 8d 65 d8          	lea    -0x28(%rbp),%rsp
    1efa:	5b                   	pop    %rbx
    1efb:	41 5c                	pop    %r12
    1efd:	41 5d                	pop    %r13
    1eff:	41 5e                	pop    %r14
...
0000000000001f10 <__program_gather_load_static_veclen_256_cpy>:
    1f10:	e9 bb f9 ff ff       	jmpq   18d0 <_Z52__program_gather_load_static_veclen_256_cpy_internalP41gather_load_static_veclen_256_cpy_state_tPdPlS1_d@plt>
    1f15:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1f1c:	00 00 00 00 

0000000000001f20 <__dace_init_gather_load_static_veclen_256_cpy>:
    1f20:	50                   	push   %rax
...
0000000000001f40 <__dace_exit_gather_load_static_veclen_256_cpy>:
    1f40:	48 85 ff             	test   %rdi,%rdi
    1f43:	74 23                	je     1f68 <__dace_exit_gather_load_static_veclen_256_cpy+0x28>
    1f45:	53                   	push   %rbx
    1f46:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f4a:	48 85 c0             	test   %rax,%rax
    1f4d:	74 0e                	je     1f5d <__dace_exit_gather_load_static_veclen_256_cpy+0x1d>
...
0000000000002040 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    20df:	48 8d 35 d3 11 00 00 	lea    0x11d3(%rip),%rsi        # 32b9 <_fini+0x26d>
    ...
    20f3:	48 8d 35 c1 11 00 00 	lea    0x11c1(%rip),%rsi        # 32bb <_fini+0x26f>
    ...
    2120:	48 8d 35 9c 11 00 00 	lea    0x119c(%rip),%rsi        # 32c3 <_fini+0x277>
    ...
    2242:	48 8d 35 97 10 00 00 	lea    0x1097(%rip),%rsi        # 32e0 <_fini+0x294>
    ...
    22ae:	48 8d 35 14 10 00 00 	lea    0x1014(%rip),%rsi        # 32c9 <_fini+0x27d>
    ...
    2336:	48 8d 1d af 0f 00 00 	lea    0xfaf(%rip),%rbx        # 32ec <_fini+0x2a0>
    233d:	4c 8d 3d a9 0f 00 00 	lea    0xfa9(%rip),%r15        # 32ed <_fini+0x2a1>
    ...
    235c:	48 8d 35 f4 0f 00 00 	lea    0xff4(%rip),%rsi        # 3357 <_fini+0x30b>
    ...
    23c1:	48 8d 35 14 0f 00 00 	lea    0xf14(%rip),%rsi        # 32dc <_fini+0x290>
    ...
    23d5:	48 8d 35 06 0f 00 00 	lea    0xf06(%rip),%rsi        # 32e2 <_fini+0x296>
    ...
    2413:	48 8d 35 d6 0e 00 00 	lea    0xed6(%rip),%rsi        # 32f0 <_fini+0x2a4>
    ...
    2451:	48 8d 35 a1 0e 00 00 	lea    0xea1(%rip),%rsi        # 32f9 <_fini+0x2ad>
    ...
    2490:	48 8d 35 6a 0e 00 00 	lea    0xe6a(%rip),%rsi        # 3301 <_fini+0x2b5>
    ...
    24c7:	48 8d 35 3a 0e 00 00 	lea    0xe3a(%rip),%rsi        # 3308 <_fini+0x2bc>
    ...
    24fb:	48 8d 35 0e 0e 00 00 	lea    0xe0e(%rip),%rsi        # 3310 <_fini+0x2c4>
    ...
    252b:	48 8d 35 e6 0d 00 00 	lea    0xde6(%rip),%rsi        # 3318 <_fini+0x2cc>
    ...
    255b:	48 8d 35 be 0d 00 00 	lea    0xdbe(%rip),%rsi        # 3320 <_fini+0x2d4>
    ...
    256f:	48 8d 35 b4 0d 00 00 	lea    0xdb4(%rip),%rsi        # 332a <_fini+0x2de>
    ...
    2596:	48 8d 35 98 0d 00 00 	lea    0xd98(%rip),%rsi        # 3335 <_fini+0x2e9>
    ...
    25bd:	48 8d 35 80 0d 00 00 	lea    0xd80(%rip),%rsi        # 3344 <_fini+0x2f8>
    ...
    25e4:	48 8d 35 62 0d 00 00 	lea    0xd62(%rip),%rsi        # 334d <_fini+0x301>
    ...
    2612:	48 8d 35 30 0d 00 00 	lea    0xd30(%rip),%rsi        # 3349 <_fini+0x2fd>
    ...
    2635:	48 8d 35 15 0d 00 00 	lea    0xd15(%rip),%rsi        # 3351 <_fini+0x305>
    ...
    26a9:	48 8d 35 a4 0c 00 00 	lea    0xca4(%rip),%rsi        # 3354 <_fini+0x308>
    ...
    270f:	48 8d 35 43 0c 00 00 	lea    0xc43(%rip),%rsi        # 3359 <_fini+0x30d>
    ...
    275e:	48 8d 35 ea 0b 00 00 	lea    0xbea(%rip),%rsi        # 334f <_fini+0x303>
    ...
    27c5:	48 8d 35 86 0b 00 00 	lea    0xb86(%rip),%rsi        # 3352 <_fini+0x306>
    ...
    297d:	48 8d 3d fe 09 00 00 	lea    0x9fe(%rip),%rdi        # 3382 <_fini+0x336>
...
0000000000002c90 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2ee3:	48 8d 3d 7f 04 00 00 	lea    0x47f(%rip),%rdi        # 3369 <_fini+0x31d>
...
0000000000002ef0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    303f:	48 8d 3d 3c 03 00 00 	lea    0x33c(%rip),%rdi        # 3382 <_fini+0x336>
