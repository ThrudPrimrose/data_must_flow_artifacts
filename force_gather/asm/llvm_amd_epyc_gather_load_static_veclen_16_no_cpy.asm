...
0000000000001a90 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d@plt>:
    1a90:	ff 25 aa 26 20 00    	jmpq   *0x2026aa(%rip)        # 204140 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d@@Base+0x202520>
...
0000000000001c20 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d>:
    1c20:	41 57                	push   %r15
    1c22:	41 56                	push   %r14
    1c24:	53                   	push   %rbx
    ...
    1c60:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1d50 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1c9c:	74 07                	je     1ca5 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d+0x85>
    1c9e:	e8 ed fc ff ff       	callq  1990 <pthread_self@plt>
    1ca3:	eb 05                	jmp    1caa <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d+0x8a>
    ...
    1cfc:	48 8d 35 c2 14 00 00 	lea    0x14c2(%rip),%rsi        # 31c5 <_fini+0x1d9>
    1d03:	48 8d 15 e4 14 00 00 	lea    0x14e4(%rip),%rdx        # 31ee <_fini+0x202>
    ...
    1d20:	48 8d 35 cd 14 00 00 	lea    0x14cd(%rip),%rsi        # 31f4 <_fini+0x208>
    1d27:	48 8d 15 fa 14 00 00 	lea    0x14fa(%rip),%rdx        # 3228 <_fini+0x23c>
    ...
    1d40:	e8 8b 02 00 00       	callq  1fd0 <__clang_call_terminate>
    1d45:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d4c:	00 00 00 00 

0000000000001d50 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d.omp_outlined>:
    1d50:	41 57                	push   %r15
    1d52:	41 56                	push   %r14
    1d54:	41 54                	push   %r12
    1d56:	53                   	push   %rbx
    1d57:	48 83 ec 18          	sub    $0x18,%rsp
    1d5b:	8b 1f                	mov    (%rdi),%ebx
    1d5d:	4d 89 ce             	mov    %r9,%r14
    1d60:	4d 89 c7             	mov    %r8,%r15
    1d63:	49 89 cc             	mov    %rcx,%r12
    1d66:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    1d6d:	00 
    1d6e:	c7 44 24 08 ff ff 23 	movl   $0x23ffff,0x8(%rsp)
    1d75:	00 
    1d76:	c7 44 24 14 01 00 00 	movl   $0x1,0x14(%rsp)
    1d7d:	00 
    1d7e:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%rsp)
    1d85:	00 
    1d86:	48 83 ec 08          	sub    $0x8,%rsp
    1d8a:	48 8d 44 24 1c       	lea    0x1c(%rsp),%rax
    1d8f:	48 8d 3d b2 1f 20 00 	lea    0x201fb2(%rip),%rdi        # 203d48 <__dso_handle+0x8>
    1d96:	48 8d 4c 24 18       	lea    0x18(%rsp),%rcx
    1d9b:	4c 8d 44 24 14       	lea    0x14(%rsp),%r8
    1da0:	4c 8d 4c 24 10       	lea    0x10(%rsp),%r9
    1da5:	89 de                	mov    %ebx,%esi
    1da7:	ba 22 00 00 00       	mov    $0x22,%edx
    1dac:	6a 01                	pushq  $0x1
    1dae:	6a 01                	pushq  $0x1
    1db0:	50                   	push   %rax
    1db1:	e8 ba fc ff ff       	callq  1a70 <__kmpc_for_static_init_4@plt>
    1db6:	48 83 c4 20          	add    $0x20,%rsp
    1dba:	8b 4c 24 08          	mov    0x8(%rsp),%ecx
    1dbe:	4c 63 5c 24 0c       	movslq 0xc(%rsp),%r11
    1dc3:	b8 ff ff 23 00       	mov    $0x23ffff,%eax
    1dc8:	81 f9 ff ff 23 00    	cmp    $0x23ffff,%ecx
    1dce:	0f 4c c1             	cmovl  %ecx,%eax
    1dd1:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1dd5:	41 39 c3             	cmp    %eax,%r11d
    1dd8:	0f 8f ab 00 00 00    	jg     1e89 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d.omp_outlined+0x139>
    1dde:	48 8b 74 24 40       	mov    0x40(%rsp),%rsi
    1de3:	c4 c2 7d 19 06       	vbroadcastsd (%r14),%ymm0
    1de8:	49 8b 0c 24          	mov    (%r12),%rcx
    1dec:	49 8b 17             	mov    (%r15),%rdx
    1def:	4d 89 da             	mov    %r11,%r10
    1df2:	44 29 d8             	sub    %r11d,%eax
    1df5:	49 c1 e2 07          	shl    $0x7,%r10
    1df9:	ff c0                	inc    %eax
    1dfb:	48 8b 36             	mov    (%rsi),%rsi
    1dfe:	48 8d 79 20          	lea    0x20(%rcx),%rdi
    1e02:	4c 8d 41 40          	lea    0x40(%rcx),%r8
    1e06:	4c 8d 49 60          	lea    0x60(%rcx),%r9
    1e0a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1e10:	c4 a1 78 10 0c 12    	vmovups (%rdx,%r10,1),%xmm1
    1e16:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1e1a:	c5 e5 76 db          	vpcmpeqd %ymm3,%ymm3,%ymm3
    1e1e:	c5 dd 76 e4          	vpcmpeqd %ymm4,%ymm4,%ymm4
    1e22:	c5 d5 76 ed          	vpcmpeqd %ymm5,%ymm5,%ymm5
    1e26:	c5 cd 76 f6          	vpcmpeqd %ymm6,%ymm6,%ymm6
    1e2a:	c4 a1 70 c6 4c 12 10 	vshufps $0x88,0x10(%rdx,%r10,1),%xmm1,%xmm1
    1e31:	88 
    1e32:	c4 e2 e5 92 14 89    	vgatherdpd %ymm3,(%rcx,%xmm1,4),%ymm2
    1e38:	c5 e1 57 db          	vxorpd %xmm3,%xmm3,%xmm3
    1e3c:	c4 e2 dd 92 1c 8f    	vgatherdpd %ymm4,(%rdi,%xmm1,4),%ymm3
    1e42:	c5 d9 57 e4          	vxorpd %xmm4,%xmm4,%xmm4
    1e46:	c4 c2 d5 92 24 88    	vgatherdpd %ymm5,(%r8,%xmm1,4),%ymm4
    1e4c:	c5 d1 57 ed          	vxorpd %xmm5,%xmm5,%xmm5
    1e50:	c4 c2 cd 92 2c 89    	vgatherdpd %ymm6,(%r9,%xmm1,4),%ymm5
    1e56:	c5 fd 59 ca          	vmulpd %ymm2,%ymm0,%ymm1
    1e5a:	c4 a1 7d 11 0c 16    	vmovupd %ymm1,(%rsi,%r10,1)
    1e60:	c5 fd 59 cb          	vmulpd %ymm3,%ymm0,%ymm1
    1e64:	c4 a1 7d 11 4c 16 20 	vmovupd %ymm1,0x20(%rsi,%r10,1)
    1e6b:	c5 fd 59 cc          	vmulpd %ymm4,%ymm0,%ymm1
    1e6f:	c4 a1 7d 11 4c 16 40 	vmovupd %ymm1,0x40(%rsi,%r10,1)
    1e76:	c5 d5 59 c8          	vmulpd %ymm0,%ymm5,%ymm1
    1e7a:	c4 a1 7d 11 4c 16 60 	vmovupd %ymm1,0x60(%rsi,%r10,1)
    1e81:	49 83 ea 80          	sub    $0xffffffffffffff80,%r10
    1e85:	ff c8                	dec    %eax
    1e87:	75 87                	jne    1e10 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d.omp_outlined+0xc0>
    1e89:	48 8d 3d d0 1e 20 00 	lea    0x201ed0(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1e90:	89 de                	mov    %ebx,%esi
...
0000000000001eb0 <__program_gather_load_static_veclen_16_no_cpy>:
    1eb0:	e9 db fb ff ff       	jmpq   1a90 <_Z54__program_gather_load_static_veclen_16_no_cpy_internalP43gather_load_static_veclen_16_no_cpy_state_tPdPlS1_d@plt>
    1eb5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1ebc:	00 00 00 00 

0000000000001ec0 <__dace_init_gather_load_static_veclen_16_no_cpy>:
    1ec0:	50                   	push   %rax
...
0000000000001ee0 <__dace_exit_gather_load_static_veclen_16_no_cpy>:
    1ee0:	48 85 ff             	test   %rdi,%rdi
    1ee3:	74 23                	je     1f08 <__dace_exit_gather_load_static_veclen_16_no_cpy+0x28>
    1ee5:	53                   	push   %rbx
    1ee6:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1eea:	48 85 c0             	test   %rax,%rax
    1eed:	74 0e                	je     1efd <__dace_exit_gather_load_static_veclen_16_no_cpy+0x1d>
...
0000000000001fe0 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    207f:	48 8d 35 e3 11 00 00 	lea    0x11e3(%rip),%rsi        # 3269 <_fini+0x27d>
    ...
    2093:	48 8d 35 d1 11 00 00 	lea    0x11d1(%rip),%rsi        # 326b <_fini+0x27f>
    ...
    20c0:	48 8d 35 ac 11 00 00 	lea    0x11ac(%rip),%rsi        # 3273 <_fini+0x287>
    ...
    21e2:	48 8d 35 a7 10 00 00 	lea    0x10a7(%rip),%rsi        # 3290 <_fini+0x2a4>
    ...
    224e:	48 8d 35 24 10 00 00 	lea    0x1024(%rip),%rsi        # 3279 <_fini+0x28d>
    ...
    22d6:	48 8d 1d bf 0f 00 00 	lea    0xfbf(%rip),%rbx        # 329c <_fini+0x2b0>
    22dd:	4c 8d 3d b9 0f 00 00 	lea    0xfb9(%rip),%r15        # 329d <_fini+0x2b1>
    ...
    22fc:	48 8d 35 04 10 00 00 	lea    0x1004(%rip),%rsi        # 3307 <_fini+0x31b>
    ...
    2361:	48 8d 35 24 0f 00 00 	lea    0xf24(%rip),%rsi        # 328c <_fini+0x2a0>
    ...
    2375:	48 8d 35 16 0f 00 00 	lea    0xf16(%rip),%rsi        # 3292 <_fini+0x2a6>
    ...
    23b3:	48 8d 35 e6 0e 00 00 	lea    0xee6(%rip),%rsi        # 32a0 <_fini+0x2b4>
    ...
    23f1:	48 8d 35 b1 0e 00 00 	lea    0xeb1(%rip),%rsi        # 32a9 <_fini+0x2bd>
    ...
    2430:	48 8d 35 7a 0e 00 00 	lea    0xe7a(%rip),%rsi        # 32b1 <_fini+0x2c5>
    ...
    2467:	48 8d 35 4a 0e 00 00 	lea    0xe4a(%rip),%rsi        # 32b8 <_fini+0x2cc>
    ...
    249b:	48 8d 35 1e 0e 00 00 	lea    0xe1e(%rip),%rsi        # 32c0 <_fini+0x2d4>
    ...
    24cb:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 32c8 <_fini+0x2dc>
    ...
    24fb:	48 8d 35 ce 0d 00 00 	lea    0xdce(%rip),%rsi        # 32d0 <_fini+0x2e4>
    ...
    250f:	48 8d 35 c4 0d 00 00 	lea    0xdc4(%rip),%rsi        # 32da <_fini+0x2ee>
    ...
    2536:	48 8d 35 a8 0d 00 00 	lea    0xda8(%rip),%rsi        # 32e5 <_fini+0x2f9>
    ...
    255d:	48 8d 35 90 0d 00 00 	lea    0xd90(%rip),%rsi        # 32f4 <_fini+0x308>
    ...
    2584:	48 8d 35 72 0d 00 00 	lea    0xd72(%rip),%rsi        # 32fd <_fini+0x311>
    ...
    25b2:	48 8d 35 40 0d 00 00 	lea    0xd40(%rip),%rsi        # 32f9 <_fini+0x30d>
    ...
    25d5:	48 8d 35 25 0d 00 00 	lea    0xd25(%rip),%rsi        # 3301 <_fini+0x315>
    ...
    2649:	48 8d 35 b4 0c 00 00 	lea    0xcb4(%rip),%rsi        # 3304 <_fini+0x318>
    ...
    26af:	48 8d 35 53 0c 00 00 	lea    0xc53(%rip),%rsi        # 3309 <_fini+0x31d>
    ...
    26f9:	e8 b2 f3 ff ff       	callq  1ab0 <_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate@plt>
    26fe:	48 8d 35 fa 0b 00 00 	lea    0xbfa(%rip),%rsi        # 32ff <_fini+0x313>
    ...
    2758:	e8 e3 f0 ff ff       	callq  1840 <_ZNSo3putEc@plt>
    275d:	48 89 c7             	mov    %rax,%rdi
    2760:	e8 bb f1 ff ff       	callq  1920 <_ZNSo5flushEv@plt>
    2765:	48 8d 35 96 0b 00 00 	lea    0xb96(%rip),%rsi        # 3302 <_fini+0x316>
    ...
    27bf:	e8 7c f0 ff ff       	callq  1840 <_ZNSo3putEc@plt>
    ...
    27fd:	e8 7e f0 ff ff       	callq  1880 <_ZNSt13basic_filebufIcSt11char_traitsIcEE5closeEv@plt>
    2802:	48 8d bc 24 b0 00 00 	lea    0xb0(%rsp),%rdi
    2809:	00 
    280a:	e8 d1 f2 ff ff       	callq  1ae0 <_ZNSt12__basic_fileIcED1Ev@plt>
    ...
    2833:	00 
    2834:	e8 67 f0 ff ff       	callq  18a0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    28d9:	00 00 00 00 00 
    28de:	e8 bd ef ff ff       	callq  18a0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    291d:	48 8d 3d 0e 0a 00 00 	lea    0xa0e(%rip),%rdi        # 3332 <_fini+0x346>
    ...
    298b:	e8 40 f1 ff ff       	callq  1ad0 <_Unwind_Resume@plt>
...
0000000000002990 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii>:
    ...
    2c24:	e8 a7 ee ff ff       	callq  1ad0 <_Unwind_Resume@plt>
...
0000000000002c30 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2e83:	48 8d 3d 8f 04 00 00 	lea    0x48f(%rip),%rdi        # 3319 <_fini+0x32d>
...
0000000000002e90 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    2fdf:	48 8d 3d 4c 03 00 00 	lea    0x34c(%rip),%rdi        # 3332 <_fini+0x346>
