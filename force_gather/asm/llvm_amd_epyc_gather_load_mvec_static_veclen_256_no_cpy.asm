...
0000000000001920 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d@plt>:
    1920:	ff 25 52 27 20 00    	jmpq   *0x202752(%rip)        # 204078 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d@@Base+0x202438>
...
00000000000019b0 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii@plt>:
    19b0:	ff 25 0a 27 20 00    	jmpq   *0x20270a(%rip)        # 2040c0 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii@@Base+0x2016b0>
...
0000000000001a10 <_ZN4dace4perf6Report5resetEv@plt>:
    1a10:	ff 25 da 26 20 00    	jmpq   *0x2026da(%rip)        # 2040f0 <_ZN4dace4perf6Report5resetEv@@Base+0x202160>
...
0000000000001ac0 <_ZN4dace4perf6Report4saveEPKcS3_@plt>:
    1ac0:	ff 25 82 26 20 00    	jmpq   *0x202682(%rip)        # 204148 <_ZN4dace4perf6Report4saveEPKcS3_@@Base+0x2020e8>
...
0000000000001c40 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d>:
    1c40:	41 57                	push   %r15
    1c42:	41 56                	push   %r14
    1c44:	53                   	push   %rbx
    ...
    1c80:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1d70 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1cbc:	74 07                	je     1cc5 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d+0x85>
    1cbe:	e8 fd fc ff ff       	callq  19c0 <pthread_self@plt>
    1cc3:	eb 05                	jmp    1cca <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d+0x8a>
    ...
    1d1c:	48 8d 35 46 15 00 00 	lea    0x1546(%rip),%rsi        # 3269 <_fini+0x1fd>
    1d23:	48 8d 15 6e 15 00 00 	lea    0x156e(%rip),%rdx        # 3298 <_fini+0x22c>
    ...
    1d40:	48 8d 35 57 15 00 00 	lea    0x1557(%rip),%rsi        # 329e <_fini+0x232>
    1d47:	48 8d 15 8a 15 00 00 	lea    0x158a(%rip),%rdx        # 32d8 <_fini+0x26c>
    ...
    1d60:	e8 eb 02 00 00       	callq  2050 <__clang_call_terminate>
    1d65:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d6c:	00 00 00 00 

0000000000001d70 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined>:
    1d70:	55                   	push   %rbp
    ...
    1d7a:	41 54                	push   %r12
    1d7c:	53                   	push   %rbx
    1d7d:	48 83 e4 c0          	and    $0xffffffffffffffc0,%rsp
    1d81:	48 81 ec 80 10 00 00 	sub    $0x1080,%rsp
    1d88:	8b 37                	mov    (%rdi),%esi
    1d8a:	4d 89 c7             	mov    %r8,%r15
    1d8d:	49 89 cc             	mov    %rcx,%r12
    1d90:	4c 89 4c 24 38       	mov    %r9,0x38(%rsp)
    1d95:	c7 44 24 28 00 00 00 	movl   $0x0,0x28(%rsp)
    1d9c:	00 
    1d9d:	c7 44 24 24 ff 3f 02 	movl   $0x23fff,0x24(%rsp)
    1da4:	00 
    1da5:	c7 44 24 34 01 00 00 	movl   $0x1,0x34(%rsp)
    1dac:	00 
    1dad:	c7 44 24 30 00 00 00 	movl   $0x0,0x30(%rsp)
    1db4:	00 
    1db5:	48 83 ec 08          	sub    $0x8,%rsp
    1db9:	48 8d 44 24 3c       	lea    0x3c(%rsp),%rax
    1dbe:	48 8d 3d 83 1f 20 00 	lea    0x201f83(%rip),%rdi        # 203d48 <__dso_handle+0x8>
    1dc5:	48 8d 4c 24 38       	lea    0x38(%rsp),%rcx
    1dca:	4c 8d 44 24 30       	lea    0x30(%rsp),%r8
    1dcf:	4c 8d 4c 24 2c       	lea    0x2c(%rsp),%r9
    1dd4:	89 74 24 34          	mov    %esi,0x34(%rsp)
    1dd8:	ba 22 00 00 00       	mov    $0x22,%edx
    1ddd:	6a 01                	pushq  $0x1
    1ddf:	6a 01                	pushq  $0x1
    1de1:	50                   	push   %rax
    1de2:	e8 b9 fc ff ff       	callq  1aa0 <__kmpc_for_static_init_4@plt>
    1de7:	48 83 c4 20          	add    $0x20,%rsp
    1deb:	8b 44 24 24          	mov    0x24(%rsp),%eax
    1def:	4c 63 74 24 28       	movslq 0x28(%rsp),%r14
    1df4:	41 bd ff 3f 02 00    	mov    $0x23fff,%r13d
    1dfa:	3d ff 3f 02 00       	cmp    $0x23fff,%eax
    1dff:	44 0f 4c e8          	cmovl  %eax,%r13d
    1e03:	44 89 6c 24 24       	mov    %r13d,0x24(%rsp)
    1e08:	45 39 ee             	cmp    %r13d,%r14d
    1e0b:	0f 8f fc 00 00 00    	jg     1f0d <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0x19d>
    1e11:	48 8b 45 10          	mov    0x10(%rbp),%rax
    1e15:	4d 8b 24 24          	mov    (%r12),%r12
    1e19:	4d 8b 3f             	mov    (%r15),%r15
    1e1c:	41 ff c5             	inc    %r13d
    1e1f:	48 8b 18             	mov    (%rax),%rbx
    1e22:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1e29:	1f 84 00 00 00 00 00 
    1e30:	4c 89 f1             	mov    %r14,%rcx
    1e33:	4c 89 f0             	mov    %r14,%rax
    1e36:	4c 89 e2             	mov    %r12,%rdx
    1e39:	48 c1 e1 0b          	shl    $0xb,%rcx
    1e3d:	48 c1 e0 08          	shl    $0x8,%rax
    1e41:	c4 c1 78 10 04 0f    	vmovups (%r15,%rcx,1),%xmm0
    1e47:	c4 c1 78 c6 44 0f 10 	vshufps $0x88,0x10(%r15,%rcx,1),%xmm0,%xmm0
    1e4e:	88 
    1e4f:	48 c7 c1 fc ff ff ff 	mov    $0xfffffffffffffffc,%rcx
    1e56:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    1e5d:	00 00 00 
    1e60:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e64:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1e68:	c4 e2 f5 92 14 82    	vgatherdpd %ymm1,(%rdx,%xmm0,4),%ymm2
    1e6e:	48 83 c2 20          	add    $0x20,%rdx
    1e72:	c5 fd 29 54 cc 60    	vmovapd %ymm2,0x60(%rsp,%rcx,8)
    1e78:	48 83 c1 04          	add    $0x4,%rcx
    1e7c:	48 81 f9 fc 00 00 00 	cmp    $0xfc,%rcx
    1e83:	72 db                	jb     1e60 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0xf0>
    1e85:	48 8b 4c 24 38       	mov    0x38(%rsp),%rcx
    1e8a:	c4 e2 7d 19 01       	vbroadcastsd (%rcx),%ymm0
    1e8f:	b9 0c 00 00 00       	mov    $0xc,%ecx
    1e94:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1e9b:	00 00 00 00 00 
    1ea0:	c5 fd 59 4c cc e0    	vmulpd -0x20(%rsp,%rcx,8),%ymm0,%ymm1
    1ea6:	c5 fd 59 14 cc       	vmulpd (%rsp,%rcx,8),%ymm0,%ymm2
    1eab:	c5 fd 59 5c cc 20    	vmulpd 0x20(%rsp,%rcx,8),%ymm0,%ymm3
    1eb1:	c5 fd 59 64 cc 40    	vmulpd 0x40(%rsp,%rcx,8),%ymm0,%ymm4
    1eb7:	c5 fd 29 8c cc e0 07 	vmovapd %ymm1,0x7e0(%rsp,%rcx,8)
    1ebe:	00 00 
    1ec0:	c5 fd 29 94 cc 00 08 	vmovapd %ymm2,0x800(%rsp,%rcx,8)
    1ec7:	00 00 
    1ec9:	c5 fd 29 9c cc 20 08 	vmovapd %ymm3,0x820(%rsp,%rcx,8)
    1ed0:	00 00 
    1ed2:	c5 fd 29 a4 cc 40 08 	vmovapd %ymm4,0x840(%rsp,%rcx,8)
    1ed9:	00 00 
    1edb:	48 83 c1 10          	add    $0x10,%rcx
    1edf:	48 81 f9 0c 01 00 00 	cmp    $0x10c,%rcx
    1ee6:	75 b8                	jne    1ea0 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0x130>
    1ee8:	48 8d 3c c3          	lea    (%rbx,%rax,8),%rdi
    1eec:	ba 00 08 00 00       	mov    $0x800,%edx
    1ef1:	48 8d b4 24 40 08 00 	lea    0x840(%rsp),%rsi
    1ef8:	00 
    1ef9:	c5 f8 77             	vzeroupper 
    1efc:	e8 9f fa ff ff       	callq  19a0 <memcpy@plt>
    1f01:	49 ff c6             	inc    %r14
    1f04:	45 39 f5             	cmp    %r14d,%r13d
    1f07:	0f 85 23 ff ff ff    	jne    1e30 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0xc0>
    1f0d:	8b 74 24 2c          	mov    0x2c(%rsp),%esi
    1f11:	48 8d 3d 48 1e 20 00 	lea    0x201e48(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1f18:	e8 53 f9 ff ff       	callq  1870 <__kmpc_for_static_fini@plt>
    1f1d:	48 8d 65 d8          	lea    -0x28(%rbp),%rsp
    1f21:	5b                   	pop    %rbx
    1f22:	41 5c                	pop    %r12
    1f24:	41 5d                	pop    %r13
    1f26:	41 5e                	pop    %r14
...
0000000000001f30 <__program_gather_load_mvec_static_veclen_256_no_cpy>:
    1f30:	e9 eb f9 ff ff       	jmpq   1920 <_Z60__program_gather_load_mvec_static_veclen_256_no_cpy_internalP49gather_load_mvec_static_veclen_256_no_cpy_state_tPdPlS1_d@plt>
    1f35:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1f3c:	00 00 00 00 

0000000000001f40 <__dace_init_gather_load_mvec_static_veclen_256_no_cpy>:
    1f40:	50                   	push   %rax
    1f41:	bf 40 00 00 00       	mov    $0x40,%edi
    1f46:	e8 a5 fa ff ff       	callq  19f0 <_Znwm@plt>
...
0000000000001f60 <__dace_exit_gather_load_mvec_static_veclen_256_no_cpy>:
    1f60:	48 85 ff             	test   %rdi,%rdi
    1f63:	74 23                	je     1f88 <__dace_exit_gather_load_mvec_static_veclen_256_no_cpy+0x28>
    1f65:	53                   	push   %rbx
    1f66:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f6a:	48 85 c0             	test   %rax,%rax
    1f6d:	74 0e                	je     1f7d <__dace_exit_gather_load_mvec_static_veclen_256_no_cpy+0x1d>
    1f6f:	48 89 fb             	mov    %rdi,%rbx
    1f72:	48 89 c7             	mov    %rax,%rdi
    1f75:	e8 56 fa ff ff       	callq  19d0 <_ZdlPv@plt>
    1f7a:	48 89 df             	mov    %rbx,%rdi
    1f7d:	be 40 00 00 00       	mov    $0x40,%esi
    1f82:	e8 79 fa ff ff       	callq  1a00 <_ZdlPvm@plt>
    1f87:	5b                   	pop    %rbx
...
0000000000001f90 <_ZN4dace4perf6Report5resetEv>:
    ...
    1fa4:	e8 d7 fa ff ff       	callq  1a80 <pthread_mutex_lock@plt>
    ...
    1fe1:	e8 0a fa ff ff       	callq  19f0 <_Znwm@plt>
    ...
    1ff2:	e8 d9 f9 ff ff       	callq  19d0 <_ZdlPv@plt>
    ...
    201b:	5b                   	pop    %rbx
    201c:	41 5e                	pop    %r14
    201e:	e9 4d f9 ff ff       	jmpq   1970 <pthread_mutex_unlock@plt>
    2023:	48 83 c4 08          	add    $0x8,%rsp
    2027:	5b                   	pop    %rbx
    2028:	41 5e                	pop    %r14
    202a:	c3                   	retq   
    202b:	89 c7                	mov    %eax,%edi
    202d:	e8 fe f8 ff ff       	callq  1930 <_ZSt20__throw_system_errori@plt>
    ...
    2042:	e8 29 f9 ff ff       	callq  1970 <pthread_mutex_unlock@plt>
    2047:	4c 89 f7             	mov    %r14,%rdi
    204a:	e8 a1 fa ff ff       	callq  1af0 <_Unwind_Resume@plt>
    204f:	90                   	nop

0000000000002050 <__clang_call_terminate>:
    2050:	50                   	push   %rax
    2051:	e8 7a f8 ff ff       	callq  18d0 <__cxa_begin_catch@plt>
    2056:	e8 55 f8 ff ff       	callq  18b0 <_ZSt9terminatev@plt>
...
0000000000002060 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    2087:	e8 f4 f9 ff ff       	callq  1a80 <pthread_mutex_lock@plt>
    ...
    20a1:	e8 da f8 ff ff       	callq  1980 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode@plt>
    20a6:	e8 d5 f7 ff ff       	callq  1880 <_ZNSt6chrono3_V212system_clock3nowEv@plt>
    ...
    20cb:	e8 20 f8 ff ff       	callq  18f0 <strlen@plt>
    20d0:	4c 89 f7             	mov    %r14,%rdi
    20d3:	4c 89 fe             	mov    %r15,%rsi
    20d6:	48 89 c2             	mov    %rax,%rdx
    20d9:	e8 42 f9 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    20fa:	e8 d1 f9 ff ff       	callq  1ad0 <_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate@plt>
    20ff:	48 8d 35 13 12 00 00 	lea    0x1213(%rip),%rsi        # 3319 <_fini+0x2ad>
    2106:	ba 01 00 00 00       	mov    $0x1,%edx
    210b:	4c 89 f7             	mov    %r14,%rdi
    210e:	e8 0d f9 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2113:	48 8d 35 01 12 00 00 	lea    0x1201(%rip),%rsi        # 331b <_fini+0x2af>
    211a:	ba 07 00 00 00       	mov    $0x7,%edx
    211f:	4c 89 f7             	mov    %r14,%rdi
    2122:	e8 f9 f8 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    213b:	e8 a0 f8 ff ff       	callq  19e0 <_ZNSo9_M_insertIlEERSoT_@plt>
    2140:	48 8d 35 dc 11 00 00 	lea    0x11dc(%rip),%rsi        # 3323 <_fini+0x2b7>
    2147:	ba 05 00 00 00       	mov    $0x5,%edx
    214c:	48 89 c7             	mov    %rax,%rdi
    214f:	e8 cc f8 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    21a1:	e8 ea f7 ff ff       	callq  1990 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@plt>
    ...
    21d5:	e8 16 f8 ff ff       	callq  19f0 <_Znwm@plt>
    ...
    21e7:	e8 e4 f7 ff ff       	callq  19d0 <_ZdlPv@plt>
    ...
    222b:	e8 70 f7 ff ff       	callq  19a0 <memcpy@plt>
    ...
    2249:	e8 d2 f8 ff ff       	callq  1b20 <_ZNSt14basic_ofstreamIcSt11char_traitsIcEEC1ERKNSt7__cxx1112basic_stringIcS1_SaIcEEESt13_Ios_Openmode@plt>
    ...
    225d:	e8 6e f7 ff ff       	callq  19d0 <_ZdlPv@plt>
    2262:	48 8d 35 d7 10 00 00 	lea    0x10d7(%rip),%rsi        # 3340 <_fini+0x2d4>
    2269:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    226e:	ba 01 00 00 00       	mov    $0x1,%edx
    2273:	4c 89 6c 24 38       	mov    %r13,0x38(%rsp)
    2278:	e8 a3 f7 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    22a6:	e8 85 f7 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    22c1:	e8 9a f5 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    22c6:	48 89 c7             	mov    %rax,%rdi
    22c9:	e8 82 f6 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    22ce:	48 8d 35 54 10 00 00 	lea    0x1054(%rip),%rsi        # 3329 <_fini+0x2bd>
    22d5:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    22da:	ba 12 00 00 00       	mov    $0x12,%edx
    22df:	e8 3c f7 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    230d:	e8 1e f7 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    2328:	e8 33 f5 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    232d:	48 89 c7             	mov    %rax,%rdi
    2330:	e8 1b f6 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    2335:	e8 36 f7 ff ff       	callq  1a70 <getpid@plt>
    ...
    2356:	48 8d 1d ef 0f 00 00 	lea    0xfef(%rip),%rbx        # 334c <_fini+0x2e0>
    235d:	4c 8d 3d e9 0f 00 00 	lea    0xfe9(%rip),%r15        # 334d <_fini+0x2e1>
    ...
    237c:	48 8d 35 34 10 00 00 	lea    0x1034(%rip),%rsi        # 33b7 <_fini+0x34b>
    2383:	e8 98 f6 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    23b3:	e8 78 f6 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    23cc:	e8 8f f4 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    23d1:	48 89 c7             	mov    %rax,%rdi
    23d4:	e8 77 f5 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    23d9:	ba 05 00 00 00       	mov    $0x5,%edx
    23de:	4c 89 e7             	mov    %r12,%rdi
    23e1:	48 8d 35 54 0f 00 00 	lea    0xf54(%rip),%rsi        # 333c <_fini+0x2d0>
    23e8:	e8 33 f6 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    23ed:	ba 09 00 00 00       	mov    $0x9,%edx
    23f2:	4c 89 e7             	mov    %r12,%rdi
    23f5:	48 8d 35 46 0f 00 00 	lea    0xf46(%rip),%rsi        # 3342 <_fini+0x2d6>
    23fc:	e8 1f f6 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2401:	4d 8d 75 01          	lea    0x1(%r13),%r14
    2405:	4c 89 f7             	mov    %r14,%rdi
    2408:	e8 e3 f4 ff ff       	callq  18f0 <strlen@plt>
    240d:	4c 89 e7             	mov    %r12,%rdi
    2410:	4c 89 f6             	mov    %r14,%rsi
    2413:	48 89 c2             	mov    %rax,%rdx
    2416:	e8 05 f6 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    241b:	ba 03 00 00 00       	mov    $0x3,%edx
    2420:	4c 89 e7             	mov    %r12,%rdi
    2423:	48 89 de             	mov    %rbx,%rsi
    2426:	e8 f5 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    242b:	ba 08 00 00 00       	mov    $0x8,%edx
    2430:	4c 89 e7             	mov    %r12,%rdi
    2433:	48 8d 35 16 0f 00 00 	lea    0xf16(%rip),%rsi        # 3350 <_fini+0x2e4>
    243a:	e8 e1 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    243f:	4d 8d 75 41          	lea    0x41(%r13),%r14
    2443:	4c 89 f7             	mov    %r14,%rdi
    2446:	e8 a5 f4 ff ff       	callq  18f0 <strlen@plt>
    244b:	4c 89 e7             	mov    %r12,%rdi
    244e:	4c 89 f6             	mov    %r14,%rsi
    2451:	48 89 c2             	mov    %rax,%rdx
    2454:	e8 c7 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2459:	ba 03 00 00 00       	mov    $0x3,%edx
    245e:	4c 89 e7             	mov    %r12,%rdi
    2461:	48 89 de             	mov    %rbx,%rsi
    2464:	e8 b7 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2469:	ba 07 00 00 00       	mov    $0x7,%edx
    246e:	4c 89 e7             	mov    %r12,%rdi
    2471:	48 8d 35 e1 0e 00 00 	lea    0xee1(%rip),%rsi        # 3359 <_fini+0x2ed>
    2478:	e8 a3 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    24b0:	48 8d 35 aa 0e 00 00 	lea    0xeaa(%rip),%rsi        # 3361 <_fini+0x2f5>
    24b7:	e8 64 f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    24bc:	49 8b 75 50          	mov    0x50(%r13),%rsi
    24c0:	4c 89 e7             	mov    %r12,%rdi
    24c3:	e8 78 f4 ff ff       	callq  1940 <_ZNSo9_M_insertImEERSoT_@plt>
    ...
    24e7:	48 8d 35 7a 0e 00 00 	lea    0xe7a(%rip),%rsi        # 3368 <_fini+0x2fc>
    24ee:	e8 2d f5 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    251b:	48 8d 35 4e 0e 00 00 	lea    0xe4e(%rip),%rsi        # 3370 <_fini+0x304>
    ...
    252e:	e8 ad f5 ff ff       	callq  1ae0 <_ZNSolsEi@plt>
    ...
    254b:	48 8d 35 26 0e 00 00 	lea    0xe26(%rip),%rsi        # 3378 <_fini+0x30c>
    ...
    255e:	e8 dd f3 ff ff       	callq  1940 <_ZNSo9_M_insertImEERSoT_@plt>
    ...
    257b:	48 8d 35 fe 0d 00 00 	lea    0xdfe(%rip),%rsi        # 3380 <_fini+0x314>
    ...
    258f:	48 8d 35 f4 0d 00 00 	lea    0xdf4(%rip),%rsi        # 338a <_fini+0x31e>
    2596:	e8 85 f4 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    259b:	41 8b 75 68          	mov    0x68(%r13),%esi
    259f:	4c 89 e7             	mov    %r12,%rdi
    25a2:	e8 39 f5 ff ff       	callq  1ae0 <_ZNSolsEi@plt>
    ...
    25b6:	48 8d 35 d8 0d 00 00 	lea    0xdd8(%rip),%rsi        # 3395 <_fini+0x329>
    25bd:	e8 5e f4 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    25c2:	41 8b 75 6c          	mov    0x6c(%r13),%esi
    25c6:	4c 89 e7             	mov    %r12,%rdi
    25c9:	e8 12 f5 ff ff       	callq  1ae0 <_ZNSolsEi@plt>
    ...
    25dd:	48 8d 35 c0 0d 00 00 	lea    0xdc0(%rip),%rsi        # 33a4 <_fini+0x338>
    25e4:	e8 37 f4 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    25e9:	41 8b 75 70          	mov    0x70(%r13),%esi
    25ed:	4c 89 e7             	mov    %r12,%rdi
    25f0:	e8 eb f4 ff ff       	callq  1ae0 <_ZNSolsEi@plt>
    ...
    2604:	48 8d 35 a2 0d 00 00 	lea    0xda2(%rip),%rsi        # 33ad <_fini+0x341>
    260b:	e8 10 f4 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2610:	4d 8d 75 78          	lea    0x78(%r13),%r14
    2614:	4c 89 f7             	mov    %r14,%rdi
    2617:	e8 d4 f2 ff ff       	callq  18f0 <strlen@plt>
    261c:	4c 89 e7             	mov    %r12,%rdi
    261f:	4c 89 f6             	mov    %r14,%rsi
    2622:	48 89 c2             	mov    %rax,%rdx
    2625:	e8 f6 f3 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    262a:	ba 03 00 00 00       	mov    $0x3,%edx
    262f:	4c 89 e7             	mov    %r12,%rdi
    2632:	48 8d 35 70 0d 00 00 	lea    0xd70(%rip),%rsi        # 33a9 <_fini+0x33d>
    2639:	e8 e2 f3 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    263e:	49 8b b5 b8 00 00 00 	mov    0xb8(%r13),%rsi
    2645:	4c 89 e7             	mov    %r12,%rdi
    2648:	e8 f3 f2 ff ff       	callq  1940 <_ZNSo9_M_insertImEERSoT_@plt>
    264d:	ba 02 00 00 00       	mov    $0x2,%edx
    2652:	4c 89 e7             	mov    %r12,%rdi
    2655:	48 8d 35 55 0d 00 00 	lea    0xd55(%rip),%rsi        # 33b1 <_fini+0x345>
    265c:	e8 bf f3 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    26a1:	e8 8a f3 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    26bc:	e8 9f f1 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    26c1:	48 89 c7             	mov    %rax,%rdi
    26c4:	e8 87 f2 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    26c9:	48 8d 35 e4 0c 00 00 	lea    0xce4(%rip),%rsi        # 33b4 <_fini+0x348>
    26d0:	ba 04 00 00 00       	mov    $0x4,%edx
    26d5:	48 89 c7             	mov    %rax,%rdi
    26d8:	48 89 c3             	mov    %rax,%rbx
    26db:	e8 40 f3 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2709:	e8 22 f3 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    2722:	e8 39 f1 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    2727:	48 89 c7             	mov    %rax,%rdi
    272a:	e8 21 f2 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    272f:	48 8d 35 83 0c 00 00 	lea    0xc83(%rip),%rsi        # 33b9 <_fini+0x34d>
    2736:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    273b:	ba 0f 00 00 00       	mov    $0xf,%edx
    2740:	e8 db f2 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    2745:	4d 85 ff             	test   %r15,%r15
    2748:	74 1a                	je     2764 <_ZN4dace4perf6Report4saveEPKcS3_+0x704>
    274a:	4c 89 ff             	mov    %r15,%rdi
    274d:	e8 9e f1 ff ff       	callq  18f0 <strlen@plt>
    ...
    2779:	e8 52 f3 ff ff       	callq  1ad0 <_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate@plt>
    277e:	48 8d 35 2a 0c 00 00 	lea    0xc2a(%rip),%rsi        # 33af <_fini+0x343>
    2785:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    278a:	ba 01 00 00 00       	mov    $0x1,%edx
    278f:	e8 8c f2 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    27bd:	e8 6e f2 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    27d8:	e8 83 f0 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    27dd:	48 89 c7             	mov    %rax,%rdi
    27e0:	e8 6b f1 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    27e5:	48 8d 35 c6 0b 00 00 	lea    0xbc6(%rip),%rsi        # 33b2 <_fini+0x346>
    27ec:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    27f1:	ba 01 00 00 00       	mov    $0x1,%edx
    27f6:	e8 25 f2 ff ff       	callq  1a20 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2824:	e8 07 f2 ff ff       	callq  1a30 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    283f:	e8 1c f0 ff ff       	callq  1860 <_ZNSo3putEc@plt>
    2844:	48 89 c7             	mov    %rax,%rdi
    2847:	e8 04 f1 ff ff       	callq  1950 <_ZNSo5flushEv@plt>
    ...
    287d:	e8 1e f0 ff ff       	callq  18a0 <_ZNSt13basic_filebufIcSt11char_traitsIcEE5closeEv@plt>
    2882:	48 8d bc 24 b0 00 00 	lea    0xb0(%rsp),%rdi
    2889:	00 
    288a:	e8 71 f2 ff ff       	callq  1b00 <_ZNSt12__basic_fileIcED1Ev@plt>
    ...
    28a7:	e8 b4 f1 ff ff       	callq  1a60 <_ZNSt6localeD1Ev@plt>
    28ac:	48 8d bc 24 38 01 00 	lea    0x138(%rsp),%rdi
    28b3:	00 
    28b4:	e8 07 f0 ff ff       	callq  18c0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    2914:	e8 b7 f0 ff ff       	callq  19d0 <_ZdlPv@plt>
    2919:	48 8d bc 24 90 02 00 	lea    0x290(%rsp),%rdi
    2920:	00 
    2921:	48 89 9c 24 58 02 00 	mov    %rbx,0x258(%rsp)
    2928:	00 
    2929:	e8 32 f1 ff ff       	callq  1a60 <_ZNSt6localeD1Ev@plt>
    ...
    2959:	00 00 00 00 00 
    295e:	e8 5d ef ff ff       	callq  18c0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    2970:	e8 fb ef ff ff       	callq  1970 <pthread_mutex_unlock@plt>
    ...
    2985:	5d                   	pop    %rbp
    2986:	c3                   	retq   
    2987:	e8 b4 f0 ff ff       	callq  1a40 <_ZSt16__throw_bad_castv@plt>
    298c:	e8 af f0 ff ff       	callq  1a40 <_ZSt16__throw_bad_castv@plt>
    2991:	e8 aa f0 ff ff       	callq  1a40 <_ZSt16__throw_bad_castv@plt>
    2996:	89 c7                	mov    %eax,%edi
    2998:	e8 93 ef ff ff       	callq  1930 <_ZSt20__throw_system_errori@plt>
    299d:	48 8d 3d 3e 0a 00 00 	lea    0xa3e(%rip),%rdi        # 33e2 <_fini+0x376>
    29a4:	e8 67 ef ff ff       	callq  1910 <_ZSt20__throw_length_errorPKc@plt>
    ...
    29c0:	e8 0b f0 ff ff       	callq  19d0 <_ZdlPv@plt>
    ...
    29df:	e8 ac f0 ff ff       	callq  1a90 <_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev@plt>
    29e4:	4c 8b 64 24 08       	mov    0x8(%rsp),%r12
    29e9:	48 8d bc 24 40 02 00 	lea    0x240(%rsp),%rdi
    29f0:	00 
    29f1:	e8 6a ef ff ff       	callq  1960 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev@plt>
    ...
    2a03:	e8 68 ef ff ff       	callq  1970 <pthread_mutex_unlock@plt>
    2a08:	48 89 df             	mov    %rbx,%rdi
    2a0b:	e8 e0 f0 ff ff       	callq  1af0 <_Unwind_Resume@plt>
...
0000000000002a10 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii>:
    ...
    2a40:	e8 3b f0 ff ff       	callq  1a80 <pthread_mutex_lock@plt>
    ...
    2b52:	e8 19 ee ff ff       	callq  1970 <pthread_mutex_unlock@plt>
    ...
    2bc1:	e8 2a ee ff ff       	callq  19f0 <_Znwm@plt>
    ...
    2c3e:	e8 6d ee ff ff       	callq  1ab0 <memmove@plt>
    ...
    2c55:	e8 76 ed ff ff       	callq  19d0 <_ZdlPv@plt>
    ...
    2c87:	e8 a4 ec ff ff       	callq  1930 <_ZSt20__throw_system_errori@plt>
    ...
    2c9c:	e8 cf ec ff ff       	callq  1970 <pthread_mutex_unlock@plt>
    2ca1:	4c 89 f7             	mov    %r14,%rdi
    2ca4:	e8 47 ee ff ff       	callq  1af0 <_Unwind_Resume@plt>
...
0000000000002cb0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2f03:	48 8d 3d bf 04 00 00 	lea    0x4bf(%rip),%rdi        # 33c9 <_fini+0x35d>
    2f0a:	e8 01 ea ff ff       	callq  1910 <_ZSt20__throw_length_errorPKc@plt>
    2f0f:	90                   	nop
...
0000000000002f10 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    305f:	48 8d 3d 7c 03 00 00 	lea    0x37c(%rip),%rdi        # 33e2 <_fini+0x376>
    3066:	e8 a5 e8 ff ff       	callq  1910 <_ZSt20__throw_length_errorPKc@plt>
