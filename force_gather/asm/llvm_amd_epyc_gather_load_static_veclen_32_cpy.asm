...
00000000000018d0 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d@plt>:
    18d0:	ff 25 92 27 20 00    	jmpq   *0x202792(%rip)        # 204068 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d@@Base+0x202458>
...
0000000000001c10 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d>:
    ...
    1cec:	48 8d 35 20 15 00 00 	lea    0x1520(%rip),%rsi        # 3213 <_fini+0x1c7>
    1cf3:	48 8d 15 3f 15 00 00 	lea    0x153f(%rip),%rdx        # 3239 <_fini+0x1ed>
    ...
    1d10:	48 8d 35 28 15 00 00 	lea    0x1528(%rip),%rsi        # 323f <_fini+0x1f3>
    1d17:	48 8d 15 52 15 00 00 	lea    0x1552(%rip),%rdx        # 3270 <_fini+0x224>
...
0000000000001d40 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined>:
    ...
    1d5c:	00 
    1d5d:	c7 44 24 08 ff ff 11 	movl   $0x11ffff,0x8(%rsp)
    1d64:	00 
    ...
    1d9f:	50                   	push   %rax
    1da0:	e8 cb fc ff ff       	callq  1a70 <__kmpc_for_static_init_4@plt>
    1da5:	48 83 c4 20          	add    $0x20,%rsp
    1da9:	8b 4c 24 08          	mov    0x8(%rsp),%ecx
    1dad:	48 63 74 24 0c       	movslq 0xc(%rsp),%rsi
    1db2:	b8 ff ff 11 00       	mov    $0x11ffff,%eax
    1db7:	81 f9 ff ff 11 00    	cmp    $0x11ffff,%ecx
    1dbd:	0f 4c c1             	cmovl  %ecx,%eax
    1dc0:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1dc4:	39 c6                	cmp    %eax,%esi
    1dc6:	0f 8f 20 01 00 00    	jg     1eec <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined+0x1ac>
    1dcc:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
    1dd1:	48 89 f2             	mov    %rsi,%rdx
    1dd4:	29 f0                	sub    %esi,%eax
    1dd6:	48 c1 e2 08          	shl    $0x8,%rdx
    1dda:	ff c0                	inc    %eax
    1ddc:	0f 1f 40 00          	nopl   0x0(%rax)
    1de0:	49 8b 3e             	mov    (%r14),%rdi
    1de3:	49 8b 37             	mov    (%r15),%rsi
    1de6:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1dea:	c5 e5 76 db          	vpcmpeqd %ymm3,%ymm3,%ymm3
    1dee:	c5 dd 76 e4          	vpcmpeqd %ymm4,%ymm4,%ymm4
    ...
    1e0d:	c4 e2 7d 19 03       	vbroadcastsd (%rbx),%ymm0
    1e12:	c5 f8 10 0c 17       	vmovups (%rdi,%rdx,1),%xmm1
    1e17:	c5 f0 c6 4c 17 10 88 	vshufps $0x88,0x10(%rdi,%rdx,1),%xmm1,%xmm1
    1e1e:	c4 e2 e5 92 94 8e e0 	vgatherdpd %ymm3,0xe0(%rsi,%xmm1,4),%ymm2
    1e25:	00 00 00 
    1e28:	c5 e1 57 db          	vxorpd %xmm3,%xmm3,%xmm3
    1e2c:	c4 e2 dd 92 9c 8e c0 	vgatherdpd %ymm4,0xc0(%rsi,%xmm1,4),%ymm3
    1e33:	00 00 00 
    1e36:	c5 d9 57 e4          	vxorpd %xmm4,%xmm4,%xmm4
    1e3a:	c4 e2 d5 92 a4 8e a0 	vgatherdpd %ymm5,0xa0(%rsi,%xmm1,4),%ymm4
    1e41:	00 00 00 
    1e44:	c5 d1 57 ed          	vxorpd %xmm5,%xmm5,%xmm5
    1e48:	c4 e2 cd 92 ac 8e 80 	vgatherdpd %ymm6,0x80(%rsi,%xmm1,4),%ymm5
    1e4f:	00 00 00 
    1e52:	c5 c9 57 f6          	vxorpd %xmm6,%xmm6,%xmm6
    1e56:	c4 e2 c5 92 74 8e 60 	vgatherdpd %ymm7,0x60(%rsi,%xmm1,4),%ymm6
    1e5d:	c5 c1 57 ff          	vxorpd %xmm7,%xmm7,%xmm7
    1e61:	c4 e2 bd 92 7c 8e 40 	vgatherdpd %ymm8,0x40(%rsi,%xmm1,4),%ymm7
    1e68:	c4 41 39 57 c0       	vxorpd %xmm8,%xmm8,%xmm8
    1e6d:	c4 62 b5 92 44 8e 20 	vgatherdpd %ymm9,0x20(%rsi,%xmm1,4),%ymm8
    1e74:	c4 41 31 57 c9       	vxorpd %xmm9,%xmm9,%xmm9
    1e79:	c4 62 ad 92 0c 8e    	vgatherdpd %ymm10,(%rsi,%xmm1,4),%ymm9
    1e7f:	48 8b 31             	mov    (%rcx),%rsi
    1e82:	c5 e5 59 d8          	vmulpd %ymm0,%ymm3,%ymm3
    1e86:	c5 dd 59 e0          	vmulpd %ymm0,%ymm4,%ymm4
    1e8a:	c5 d5 59 e8          	vmulpd %ymm0,%ymm5,%ymm5
    1e8e:	c5 cd 59 f0          	vmulpd %ymm0,%ymm6,%ymm6
    1e92:	c5 c5 59 f8          	vmulpd %ymm0,%ymm7,%ymm7
    1e96:	c5 3d 59 c0          	vmulpd %ymm0,%ymm8,%ymm8
    1e9a:	c5 b5 59 c8          	vmulpd %ymm0,%ymm9,%ymm1
    1e9e:	c5 ed 59 c0          	vmulpd %ymm0,%ymm2,%ymm0
    1ea2:	c5 fd 11 0c 16       	vmovupd %ymm1,(%rsi,%rdx,1)
    1ea7:	c5 7d 11 44 16 20    	vmovupd %ymm8,0x20(%rsi,%rdx,1)
    1ead:	c5 fd 11 7c 16 40    	vmovupd %ymm7,0x40(%rsi,%rdx,1)
    1eb3:	c5 fd 11 74 16 60    	vmovupd %ymm6,0x60(%rsi,%rdx,1)
    1eb9:	c5 fd 11 ac 16 80 00 	vmovupd %ymm5,0x80(%rsi,%rdx,1)
    1ec0:	00 00 
    1ec2:	c5 fd 11 a4 16 a0 00 	vmovupd %ymm4,0xa0(%rsi,%rdx,1)
    1ec9:	00 00 
    1ecb:	c5 fd 11 9c 16 c0 00 	vmovupd %ymm3,0xc0(%rsi,%rdx,1)
    1ed2:	00 00 
    1ed4:	c5 fd 11 84 16 e0 00 	vmovupd %ymm0,0xe0(%rsi,%rdx,1)
    1edb:	00 00 
    1edd:	48 81 c2 00 01 00 00 	add    $0x100,%rdx
    1ee4:	ff c8                	dec    %eax
    1ee6:	0f 85 f4 fe ff ff    	jne    1de0 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined+0xa0>
    1eec:	48 8d 3d 6d 1e 20 00 	lea    0x201e6d(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1ef3:	89 ee                	mov    %ebp,%esi
    1ef5:	c5 f8 77             	vzeroupper 
    1ef8:	e8 43 f9 ff ff       	callq  1840 <__kmpc_for_static_fini@plt>
...
0000000000001f10 <__program_gather_load_static_veclen_32_cpy>:
    1f10:	e9 bb f9 ff ff       	jmpq   18d0 <_Z51__program_gather_load_static_veclen_32_cpy_internalP40gather_load_static_veclen_32_cpy_state_tPdPlS1_d@plt>
    1f15:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1f1c:	00 00 00 00 

0000000000001f20 <__dace_init_gather_load_static_veclen_32_cpy>:
    1f20:	50                   	push   %rax
...
0000000000001f40 <__dace_exit_gather_load_static_veclen_32_cpy>:
    1f40:	48 85 ff             	test   %rdi,%rdi
    1f43:	74 23                	je     1f68 <__dace_exit_gather_load_static_veclen_32_cpy+0x28>
    1f45:	53                   	push   %rbx
    1f46:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f4a:	48 85 c0             	test   %rax,%rax
    1f4d:	74 0e                	je     1f5d <__dace_exit_gather_load_static_veclen_32_cpy+0x1d>
...
0000000000002040 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    20df:	48 8d 35 cb 11 00 00 	lea    0x11cb(%rip),%rsi        # 32b1 <_fini+0x265>
    ...
    20f3:	48 8d 35 b9 11 00 00 	lea    0x11b9(%rip),%rsi        # 32b3 <_fini+0x267>
    ...
    2120:	48 8d 35 94 11 00 00 	lea    0x1194(%rip),%rsi        # 32bb <_fini+0x26f>
    ...
    2242:	48 8d 35 8f 10 00 00 	lea    0x108f(%rip),%rsi        # 32d8 <_fini+0x28c>
    ...
    22ae:	48 8d 35 0c 10 00 00 	lea    0x100c(%rip),%rsi        # 32c1 <_fini+0x275>
    ...
    2336:	48 8d 1d a7 0f 00 00 	lea    0xfa7(%rip),%rbx        # 32e4 <_fini+0x298>
    233d:	4c 8d 3d a1 0f 00 00 	lea    0xfa1(%rip),%r15        # 32e5 <_fini+0x299>
    ...
    235c:	48 8d 35 ec 0f 00 00 	lea    0xfec(%rip),%rsi        # 334f <_fini+0x303>
    ...
    23c1:	48 8d 35 0c 0f 00 00 	lea    0xf0c(%rip),%rsi        # 32d4 <_fini+0x288>
    ...
    23d5:	48 8d 35 fe 0e 00 00 	lea    0xefe(%rip),%rsi        # 32da <_fini+0x28e>
    ...
    2413:	48 8d 35 ce 0e 00 00 	lea    0xece(%rip),%rsi        # 32e8 <_fini+0x29c>
    ...
    2451:	48 8d 35 99 0e 00 00 	lea    0xe99(%rip),%rsi        # 32f1 <_fini+0x2a5>
    ...
    2490:	48 8d 35 62 0e 00 00 	lea    0xe62(%rip),%rsi        # 32f9 <_fini+0x2ad>
    ...
    24c7:	48 8d 35 32 0e 00 00 	lea    0xe32(%rip),%rsi        # 3300 <_fini+0x2b4>
    ...
    24fb:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 3308 <_fini+0x2bc>
    ...
    252b:	48 8d 35 de 0d 00 00 	lea    0xdde(%rip),%rsi        # 3310 <_fini+0x2c4>
    ...
    255b:	48 8d 35 b6 0d 00 00 	lea    0xdb6(%rip),%rsi        # 3318 <_fini+0x2cc>
    ...
    256f:	48 8d 35 ac 0d 00 00 	lea    0xdac(%rip),%rsi        # 3322 <_fini+0x2d6>
    ...
    2596:	48 8d 35 90 0d 00 00 	lea    0xd90(%rip),%rsi        # 332d <_fini+0x2e1>
    ...
    25bd:	48 8d 35 78 0d 00 00 	lea    0xd78(%rip),%rsi        # 333c <_fini+0x2f0>
    ...
    25e4:	48 8d 35 5a 0d 00 00 	lea    0xd5a(%rip),%rsi        # 3345 <_fini+0x2f9>
    ...
    2612:	48 8d 35 28 0d 00 00 	lea    0xd28(%rip),%rsi        # 3341 <_fini+0x2f5>
    ...
    2635:	48 8d 35 0d 0d 00 00 	lea    0xd0d(%rip),%rsi        # 3349 <_fini+0x2fd>
    ...
    26a9:	48 8d 35 9c 0c 00 00 	lea    0xc9c(%rip),%rsi        # 334c <_fini+0x300>
    ...
    270f:	48 8d 35 3b 0c 00 00 	lea    0xc3b(%rip),%rsi        # 3351 <_fini+0x305>
    ...
    275e:	48 8d 35 e2 0b 00 00 	lea    0xbe2(%rip),%rsi        # 3347 <_fini+0x2fb>
    ...
    27c5:	48 8d 35 7e 0b 00 00 	lea    0xb7e(%rip),%rsi        # 334a <_fini+0x2fe>
    ...
    297d:	48 8d 3d f6 09 00 00 	lea    0x9f6(%rip),%rdi        # 337a <_fini+0x32e>
...
0000000000002c90 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2ee3:	48 8d 3d 77 04 00 00 	lea    0x477(%rip),%rdi        # 3361 <_fini+0x315>
...
0000000000002ef0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    303f:	48 8d 3d 34 03 00 00 	lea    0x334(%rip),%rdi        # 337a <_fini+0x32e>
