...
0000000000001980 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d@plt>:
    1980:	ff 25 0a 27 20 00    	jmpq   *0x20270a(%rip)        # 204090 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d@@Base+0x202420>
...
0000000000001c70 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d>:
    1c70:	41 57                	push   %r15
    1c72:	41 56                	push   %r14
    1c74:	53                   	push   %rbx
    ...
    1cb0:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1da0 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1cec:	74 07                	je     1cf5 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d+0x85>
    1cee:	e8 fd fc ff ff       	callq  19f0 <pthread_self@plt>
    1cf3:	eb 05                	jmp    1cfa <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d+0x8a>
    ...
    1d4c:	48 8d 35 00 15 00 00 	lea    0x1500(%rip),%rsi        # 3253 <_fini+0x227>
    1d53:	48 8d 15 2f 15 00 00 	lea    0x152f(%rip),%rdx        # 3289 <_fini+0x25d>
    ...
    1d70:	48 8d 35 18 15 00 00 	lea    0x1518(%rip),%rsi        # 328f <_fini+0x263>
    1d77:	48 8d 15 52 15 00 00 	lea    0x1552(%rip),%rdx        # 32d0 <_fini+0x2a4>
    ...
    1d90:	e8 7b 02 00 00       	callq  2010 <__clang_call_terminate>
    1d95:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d9c:	00 00 00 00 

0000000000001da0 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined>:
    1da0:	55                   	push   %rbp
    1da1:	41 57                	push   %r15
    1da3:	41 56                	push   %r14
    1da5:	53                   	push   %rbx
    1da6:	48 83 ec 18          	sub    $0x18,%rsp
    1daa:	8b 2f                	mov    (%rdi),%ebp
    1dac:	4c 89 cb             	mov    %r9,%rbx
    1daf:	4d 89 c6             	mov    %r8,%r14
    1db2:	49 89 cf             	mov    %rcx,%r15
    1db5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    1dbc:	00 
    1dbd:	c7 44 24 08 ff ff 23 	movl   $0x23ffff,0x8(%rsp)
    1dc4:	00 
    1dc5:	c7 44 24 14 01 00 00 	movl   $0x1,0x14(%rsp)
    1dcc:	00 
    1dcd:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%rsp)
    1dd4:	00 
    1dd5:	48 83 ec 08          	sub    $0x8,%rsp
    1dd9:	48 8d 44 24 1c       	lea    0x1c(%rsp),%rax
    1dde:	89 ee                	mov    %ebp,%esi
    1de0:	48 8d 3d 61 1f 20 00 	lea    0x201f61(%rip),%rdi        # 203d48 <__dso_handle+0x8>
    1de7:	48 8d 4c 24 18       	lea    0x18(%rsp),%rcx
    1dec:	4c 8d 44 24 14       	lea    0x14(%rsp),%r8
    1df1:	4c 8d 4c 24 10       	lea    0x10(%rsp),%r9
    1df6:	ba 22 00 00 00       	mov    $0x22,%edx
    1dfb:	6a 01                	pushq  $0x1
    1dfd:	6a 01                	pushq  $0x1
    1dff:	50                   	push   %rax
    1e00:	e8 cb fc ff ff       	callq  1ad0 <__kmpc_for_static_init_4@plt>
    1e05:	48 83 c4 20          	add    $0x20,%rsp
    1e09:	8b 4c 24 08          	mov    0x8(%rsp),%ecx
    1e0d:	48 63 74 24 0c       	movslq 0xc(%rsp),%rsi
    1e12:	b8 ff ff 23 00       	mov    $0x23ffff,%eax
    1e17:	81 f9 ff ff 23 00    	cmp    $0x23ffff,%ecx
    1e1d:	0f 4c c1             	cmovl  %ecx,%eax
    1e20:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1e24:	39 c6                	cmp    %eax,%esi
    1e26:	0f 8f 9c 00 00 00    	jg     1ec8 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined+0x128>
    1e2c:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
    1e31:	48 89 f2             	mov    %rsi,%rdx
    1e34:	29 f0                	sub    %esi,%eax
    1e36:	48 c1 e2 07          	shl    $0x7,%rdx
    1e3a:	ff c0                	inc    %eax
    1e3c:	0f 1f 40 00          	nopl   0x0(%rax)
    1e40:	49 8b 3e             	mov    (%r14),%rdi
    1e43:	49 8b 37             	mov    (%r15),%rsi
    1e46:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e4a:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1e4e:	c5 e1 57 db          	vxorpd %xmm3,%xmm3,%xmm3
    1e52:	c5 d9 57 e4          	vxorpd %xmm4,%xmm4,%xmm4
    1e56:	c5 d1 57 ed          	vxorpd %xmm5,%xmm5,%xmm5
    1e5a:	c5 f8 10 04 17       	vmovups (%rdi,%rdx,1),%xmm0
    1e5f:	c5 f8 c6 44 17 10 88 	vshufps $0x88,0x10(%rdi,%rdx,1),%xmm0,%xmm0
    1e66:	c4 e2 f5 92 14 86    	vgatherdpd %ymm1,(%rsi,%xmm0,4),%ymm2
    1e6c:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e70:	c4 e2 f5 92 5c 86 20 	vgatherdpd %ymm1,0x20(%rsi,%xmm0,4),%ymm3
    1e77:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e7b:	c4 e2 f5 92 64 86 40 	vgatherdpd %ymm1,0x40(%rsi,%xmm0,4),%ymm4
    1e82:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e86:	c4 e2 f5 92 6c 86 60 	vgatherdpd %ymm1,0x60(%rsi,%xmm0,4),%ymm5
    1e8d:	c4 e2 7d 19 03       	vbroadcastsd (%rbx),%ymm0
    1e92:	48 8b 31             	mov    (%rcx),%rsi
    1e95:	c5 fd 59 ca          	vmulpd %ymm2,%ymm0,%ymm1
    1e99:	c5 fd 11 0c 16       	vmovupd %ymm1,(%rsi,%rdx,1)
    1e9e:	c5 fd 59 cb          	vmulpd %ymm3,%ymm0,%ymm1
    1ea2:	c5 fd 11 4c 16 20    	vmovupd %ymm1,0x20(%rsi,%rdx,1)
    1ea8:	c5 fd 59 cc          	vmulpd %ymm4,%ymm0,%ymm1
    1eac:	c5 fd 11 4c 16 40    	vmovupd %ymm1,0x40(%rsi,%rdx,1)
    1eb2:	c5 d5 59 c0          	vmulpd %ymm0,%ymm5,%ymm0
    1eb6:	c5 fd 11 44 16 60    	vmovupd %ymm0,0x60(%rsi,%rdx,1)
    1ebc:	48 83 ea 80          	sub    $0xffffffffffffff80,%rdx
    1ec0:	ff c8                	dec    %eax
    1ec2:	0f 85 78 ff ff ff    	jne    1e40 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d.omp_outlined+0xa0>
    1ec8:	48 8d 3d 91 1e 20 00 	lea    0x201e91(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1ecf:	89 ee                	mov    %ebp,%esi
    1ed1:	c5 f8 77             	vzeroupper 
    1ed4:	e8 c7 f9 ff ff       	callq  18a0 <__kmpc_for_static_fini@plt>
    1ed9:	48 83 c4 18          	add    $0x18,%rsp
    1edd:	5b                   	pop    %rbx
    1ede:	41 5e                	pop    %r14
    1ee0:	41 5f                	pop    %r15
    1ee2:	5d                   	pop    %rbp
...
0000000000001ef0 <__program_gather_load_force_width_512_static_veclen_16_cpy>:
    1ef0:	e9 8b fa ff ff       	jmpq   1980 <_Z67__program_gather_load_force_width_512_static_veclen_16_cpy_internalP56gather_load_force_width_512_static_veclen_16_cpy_state_tPdPlS1_d@plt>
    1ef5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1efc:	00 00 00 00 

0000000000001f00 <__dace_init_gather_load_force_width_512_static_veclen_16_cpy>:
    1f00:	50                   	push   %rax
...
0000000000001f20 <__dace_exit_gather_load_force_width_512_static_veclen_16_cpy>:
    1f20:	48 85 ff             	test   %rdi,%rdi
    1f23:	74 23                	je     1f48 <__dace_exit_gather_load_force_width_512_static_veclen_16_cpy+0x28>
    1f25:	53                   	push   %rbx
    1f26:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f2a:	48 85 c0             	test   %rax,%rax
    1f2d:	74 0e                	je     1f3d <__dace_exit_gather_load_force_width_512_static_veclen_16_cpy+0x1d>
...
0000000000002020 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    20bf:	48 8d 35 4b 12 00 00 	lea    0x124b(%rip),%rsi        # 3311 <_fini+0x2e5>
    ...
    20d3:	48 8d 35 39 12 00 00 	lea    0x1239(%rip),%rsi        # 3313 <_fini+0x2e7>
    ...
    2100:	48 8d 35 14 12 00 00 	lea    0x1214(%rip),%rsi        # 331b <_fini+0x2ef>
    ...
    2222:	48 8d 35 0f 11 00 00 	lea    0x110f(%rip),%rsi        # 3338 <_fini+0x30c>
    ...
    228e:	48 8d 35 8c 10 00 00 	lea    0x108c(%rip),%rsi        # 3321 <_fini+0x2f5>
    ...
    2316:	48 8d 1d 27 10 00 00 	lea    0x1027(%rip),%rbx        # 3344 <_fini+0x318>
    231d:	4c 8d 3d 21 10 00 00 	lea    0x1021(%rip),%r15        # 3345 <_fini+0x319>
    ...
    233c:	48 8d 35 6c 10 00 00 	lea    0x106c(%rip),%rsi        # 33af <_fini+0x383>
    ...
    23a1:	48 8d 35 8c 0f 00 00 	lea    0xf8c(%rip),%rsi        # 3334 <_fini+0x308>
    ...
    23b5:	48 8d 35 7e 0f 00 00 	lea    0xf7e(%rip),%rsi        # 333a <_fini+0x30e>
    ...
    23f3:	48 8d 35 4e 0f 00 00 	lea    0xf4e(%rip),%rsi        # 3348 <_fini+0x31c>
    ...
    2431:	48 8d 35 19 0f 00 00 	lea    0xf19(%rip),%rsi        # 3351 <_fini+0x325>
    ...
    2470:	48 8d 35 e2 0e 00 00 	lea    0xee2(%rip),%rsi        # 3359 <_fini+0x32d>
    ...
    24a7:	48 8d 35 b2 0e 00 00 	lea    0xeb2(%rip),%rsi        # 3360 <_fini+0x334>
    ...
    24db:	48 8d 35 86 0e 00 00 	lea    0xe86(%rip),%rsi        # 3368 <_fini+0x33c>
    ...
    250b:	48 8d 35 5e 0e 00 00 	lea    0xe5e(%rip),%rsi        # 3370 <_fini+0x344>
    ...
    253b:	48 8d 35 36 0e 00 00 	lea    0xe36(%rip),%rsi        # 3378 <_fini+0x34c>
    ...
    254f:	48 8d 35 2c 0e 00 00 	lea    0xe2c(%rip),%rsi        # 3382 <_fini+0x356>
    ...
    2576:	48 8d 35 10 0e 00 00 	lea    0xe10(%rip),%rsi        # 338d <_fini+0x361>
    ...
    259d:	48 8d 35 f8 0d 00 00 	lea    0xdf8(%rip),%rsi        # 339c <_fini+0x370>
    ...
    25c4:	48 8d 35 da 0d 00 00 	lea    0xdda(%rip),%rsi        # 33a5 <_fini+0x379>
    ...
    25f2:	48 8d 35 a8 0d 00 00 	lea    0xda8(%rip),%rsi        # 33a1 <_fini+0x375>
    ...
    2615:	48 8d 35 8d 0d 00 00 	lea    0xd8d(%rip),%rsi        # 33a9 <_fini+0x37d>
    ...
    2689:	48 8d 35 1c 0d 00 00 	lea    0xd1c(%rip),%rsi        # 33ac <_fini+0x380>
    ...
    26ef:	48 8d 35 bb 0c 00 00 	lea    0xcbb(%rip),%rsi        # 33b1 <_fini+0x385>
    ...
    273e:	48 8d 35 62 0c 00 00 	lea    0xc62(%rip),%rsi        # 33a7 <_fini+0x37b>
    ...
    27a0:	e8 cb f1 ff ff       	callq  1970 <_ZNSo5flushEv@plt>
    27a5:	48 8d 35 fe 0b 00 00 	lea    0xbfe(%rip),%rsi        # 33aa <_fini+0x37e>
    ...
    2807:	e8 64 f1 ff ff       	callq  1970 <_ZNSo5flushEv@plt>
    ...
    2958:	e8 f3 ef ff ff       	callq  1950 <_ZSt20__throw_system_errori@plt>
    295d:	48 8d 3d 76 0a 00 00 	lea    0xa76(%rip),%rdi        # 33da <_fini+0x3ae>
    2964:	e8 d7 ef ff ff       	callq  1940 <_ZSt20__throw_length_errorPKc@plt>
...
00000000000029d0 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii>:
    ...
    2c47:	e8 04 ed ff ff       	callq  1950 <_ZSt20__throw_system_errori@plt>
...
0000000000002c70 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2ec3:	48 8d 3d f7 04 00 00 	lea    0x4f7(%rip),%rdi        # 33c1 <_fini+0x395>
...
0000000000002ed0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    301f:	48 8d 3d b4 03 00 00 	lea    0x3b4(%rip),%rdi        # 33da <_fini+0x3ae>
