...
00000000000019b0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@plt>:
    19b0:	ff 25 f2 26 20 00    	jmpq   *0x2026f2(%rip)        # 2040a8 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@@Base+0x201268>
...
0000000000001a30 <_ZN4dace4perf6Report5resetEv@plt>:
    1a30:	ff 25 b2 26 20 00    	jmpq   *0x2026b2(%rip)        # 2040e8 <_ZN4dace4perf6Report5resetEv@@Base+0x201f98>
...
0000000000001a70 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm@plt>:
    1a70:	ff 25 92 26 20 00    	jmpq   *0x202692(%rip)        # 204108 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm@@Base+0x201068>
...
0000000000001ac0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d@plt>:
    1ac0:	ff 25 6a 26 20 00    	jmpq   *0x20266a(%rip)        # 204130 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d@@Base+0x202370>
...
0000000000001dc0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d>:
    1dc0:	41 57                	push   %r15
    1dc2:	41 56                	push   %r14
    1dc4:	53                   	push   %rbx
    ...
    1e00:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1ef0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1e3b:	00 
    1e3c:	74 07                	je     1e45 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d+0x85>
    1e3e:	e8 9d fb ff ff       	callq  19e0 <pthread_self@plt>
    1e43:	eb 05                	jmp    1e4a <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d+0x8a>
    ...
    1e9c:	48 8d 35 8e 15 00 00 	lea    0x158e(%rip),%rsi        # 3431 <_fini+0x235>
    1ea3:	48 8d 15 bf 15 00 00 	lea    0x15bf(%rip),%rdx        # 3469 <_fini+0x26d>
    ...
    1ec0:	48 8d 35 a8 15 00 00 	lea    0x15a8(%rip),%rsi        # 346f <_fini+0x273>
    1ec7:	48 8d 15 e4 15 00 00 	lea    0x15e4(%rip),%rdx        # 34b2 <_fini+0x2b6>
...
0000000000001ef0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined>:
    1ef0:	41 57                	push   %r15
    1ef2:	41 56                	push   %r14
    1ef4:	41 54                	push   %r12
    1ef6:	53                   	push   %rbx
    ...
    1f0b:	00 
    1f0c:	c7 44 24 08 ff ff 47 	movl   $0x47ffff,0x8(%rsp)
    1f13:	00 
    ...
    1f5e:	81 f9 ff ff 47 00    	cmp    $0x47ffff,%ecx
    1f64:	b8 ff ff 47 00       	mov    $0x47ffff,%eax
    1f69:	0f 4c c1             	cmovl  %ecx,%eax
    1f6c:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1f70:	48 63 7c 24 0c       	movslq 0xc(%rsp),%rdi
    1f75:	39 f8                	cmp    %edi,%eax
    1f77:	0f 8c 55 01 00 00    	jl     20d2 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined+0x1e2>
    1f7d:	48 8b 74 24 40       	mov    0x40(%rsp),%rsi
    1f82:	49 8b 0c 24          	mov    (%r12),%rcx
    1f86:	49 8b 17             	mov    (%r15),%rdx
    1f89:	48 8b 36             	mov    (%rsi),%rsi
    1f8c:	62 d2 fd 48 19 06    	vbroadcastsd (%r14),%zmm0
    1f92:	41 89 c0             	mov    %eax,%r8d
    1f95:	41 29 f8             	sub    %edi,%r8d
    1f98:	45 8d 70 01          	lea    0x1(%r8),%r14d
    1f9c:	41 83 e6 03          	and    $0x3,%r14d
    1fa0:	74 6a                	je     200c <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined+0x11c>
    1fa2:	49 89 f9             	mov    %rdi,%r9
    1fa5:	49 c1 e1 06          	shl    $0x6,%r9
    1fa9:	4e 8d 14 0e          	lea    (%rsi,%r9,1),%r10
    1fad:	49 01 d1             	add    %rdx,%r9
    1fb0:	41 89 c3             	mov    %eax,%r11d
    1fb3:	41 28 fb             	sub    %dil,%r11b
    1fb6:	41 fe c3             	inc    %r11b
    1fb9:	45 0f b6 db          	movzbl %r11b,%r11d
    1fbd:	41 83 e3 03          	and    $0x3,%r11d
    1fc1:	41 c1 e3 06          	shl    $0x6,%r11d
    1fc5:	41 ff ce             	dec    %r14d
    1fc8:	4c 01 f7             	add    %r14,%rdi
    1fcb:	48 ff c7             	inc    %rdi
    1fce:	45 31 f6             	xor    %r14d,%r14d
    1fd1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1fd8:	0f 1f 84 00 00 00 00 
    1fdf:	00 
    1fe0:	62 91 fd 48 10 0c 31 	vmovupd (%r9,%r14,1),%zmm1
    1fe7:	c5 fc 46 c8          	kxnorw %k0,%k0,%k1
    1feb:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1fef:	62 f2 fd 49 93 14 c9 	vgatherqpd (%rcx,%zmm1,8),%zmm2{%k1}
    1ff6:	62 f1 ed 48 59 c8    	vmulpd %zmm0,%zmm2,%zmm1
    1ffc:	62 91 fd 48 11 0c 32 	vmovupd %zmm1,(%r10,%r14,1)
    2003:	49 83 c6 40          	add    $0x40,%r14
    2007:	45 39 f3             	cmp    %r14d,%r11d
    200a:	75 d4                	jne    1fe0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined+0xf0>
    200c:	41 83 f8 03          	cmp    $0x3,%r8d
    2010:	0f 82 bc 00 00 00    	jb     20d2 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined+0x1e2>
    2016:	49 89 f8             	mov    %rdi,%r8
    2019:	49 c1 e0 06          	shl    $0x6,%r8
    201d:	49 81 c0 c0 00 00 00 	add    $0xc0,%r8
    2024:	29 f8                	sub    %edi,%eax
    2026:	ff c0                	inc    %eax
    2028:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    202f:	00 
    2030:	62 b1 fd 48 10 4c 02 	vmovupd -0xc0(%rdx,%r8,1),%zmm1
    2037:	fd 
    2038:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    203c:	c5 fc 46 c8          	kxnorw %k0,%k0,%k1
    2040:	62 f2 fd 49 93 14 c9 	vgatherqpd (%rcx,%zmm1,8),%zmm2{%k1}
    2047:	62 f1 ed 48 59 c8    	vmulpd %zmm0,%zmm2,%zmm1
    204d:	62 b1 fd 48 11 4c 06 	vmovupd %zmm1,-0xc0(%rsi,%r8,1)
    2054:	fd 
    2055:	62 b1 fd 48 10 4c 02 	vmovupd -0x80(%rdx,%r8,1),%zmm1
    205c:	fe 
    205d:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    2061:	c5 fc 46 c8          	kxnorw %k0,%k0,%k1
    2065:	62 f2 fd 49 93 14 c9 	vgatherqpd (%rcx,%zmm1,8),%zmm2{%k1}
    206c:	62 f1 ed 48 59 c8    	vmulpd %zmm0,%zmm2,%zmm1
    2072:	62 b1 fd 48 11 4c 06 	vmovupd %zmm1,-0x80(%rsi,%r8,1)
    2079:	fe 
    207a:	62 b1 fd 48 10 4c 02 	vmovupd -0x40(%rdx,%r8,1),%zmm1
    2081:	ff 
    2082:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    2086:	c5 fc 46 c8          	kxnorw %k0,%k0,%k1
    208a:	62 f2 fd 49 93 14 c9 	vgatherqpd (%rcx,%zmm1,8),%zmm2{%k1}
    2091:	62 f1 ed 48 59 c8    	vmulpd %zmm0,%zmm2,%zmm1
    2097:	62 b1 fd 48 11 4c 06 	vmovupd %zmm1,-0x40(%rsi,%r8,1)
    209e:	ff 
    209f:	62 b1 fd 48 10 0c 02 	vmovupd (%rdx,%r8,1),%zmm1
    20a6:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    20aa:	c5 fc 46 c8          	kxnorw %k0,%k0,%k1
    20ae:	62 f2 fd 49 93 14 c9 	vgatherqpd (%rcx,%zmm1,8),%zmm2{%k1}
    20b5:	62 f1 ed 48 59 c8    	vmulpd %zmm0,%zmm2,%zmm1
    20bb:	62 b1 fd 48 11 0c 06 	vmovupd %zmm1,(%rsi,%r8,1)
    20c2:	49 81 c0 00 01 00 00 	add    $0x100,%r8
    20c9:	83 c0 fc             	add    $0xfffffffc,%eax
    20cc:	0f 85 5e ff ff ff    	jne    2030 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d.omp_outlined+0x140>
    20d2:	48 8d 3d 87 1c 20 00 	lea    0x201c87(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    20d9:	89 de                	mov    %ebx,%esi
...
00000000000020f0 <__program_gather_load_force_width_512_static_veclen_8_no_cpy>:
    20f0:	e9 cb f9 ff ff       	jmpq   1ac0 <_Z69__program_gather_load_force_width_512_static_veclen_8_no_cpy_internalP58gather_load_force_width_512_static_veclen_8_no_cpy_state_tPdPlS1_d@plt>
    20f5:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    20fc:	00 00 00 00 

0000000000002100 <__dace_init_gather_load_force_width_512_static_veclen_8_no_cpy>:
    2100:	50                   	push   %rax
    2101:	bf 40 00 00 00       	mov    $0x40,%edi
    2106:	e8 05 f9 ff ff       	callq  1a10 <_Znwm@plt>
...
0000000000002120 <__dace_exit_gather_load_force_width_512_static_veclen_8_no_cpy>:
    2120:	48 85 ff             	test   %rdi,%rdi
    2123:	74 23                	je     2148 <__dace_exit_gather_load_force_width_512_static_veclen_8_no_cpy+0x28>
    2125:	53                   	push   %rbx
    2126:	48 8b 47 28          	mov    0x28(%rdi),%rax
    212a:	48 85 c0             	test   %rax,%rax
    212d:	74 0e                	je     213d <__dace_exit_gather_load_force_width_512_static_veclen_8_no_cpy+0x1d>
    212f:	48 89 fb             	mov    %rdi,%rbx
    2132:	48 89 c7             	mov    %rax,%rdi
    2135:	e8 b6 f8 ff ff       	callq  19f0 <_ZdlPv@plt>
    213a:	48 89 df             	mov    %rbx,%rdi
    213d:	be 40 00 00 00       	mov    $0x40,%esi
    2142:	e8 d9 f8 ff ff       	callq  1a20 <_ZdlPvm@plt>
    2147:	5b                   	pop    %rbx
...
0000000000002150 <_ZN4dace4perf6Report5resetEv>:
    ...
    2164:	e8 37 f9 ff ff       	callq  1aa0 <pthread_mutex_lock@plt>
    ...
    21a1:	e8 6a f8 ff ff       	callq  1a10 <_Znwm@plt>
    ...
    21b2:	e8 39 f8 ff ff       	callq  19f0 <_ZdlPv@plt>
    ...
    21db:	5b                   	pop    %rbx
    21dc:	41 5e                	pop    %r14
    21de:	e9 ad f7 ff ff       	jmpq   1990 <pthread_mutex_unlock@plt>
    ...
    2202:	e8 89 f7 ff ff       	callq  1990 <pthread_mutex_unlock@plt>
...
0000000000002220 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    2247:	e8 54 f8 ff ff       	callq  1aa0 <pthread_mutex_lock@plt>
    ...
    2261:	e8 3a f7 ff ff       	callq  19a0 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode@plt>
    ...
    2299:	e8 a2 f7 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    22bf:	48 8d 35 2d 12 00 00 	lea    0x122d(%rip),%rsi        # 34f3 <_fini+0x2f7>
    22c6:	ba 01 00 00 00       	mov    $0x1,%edx
    22cb:	4c 89 f7             	mov    %r14,%rdi
    22ce:	e8 6d f7 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    22d3:	48 8d 35 1b 12 00 00 	lea    0x121b(%rip),%rsi        # 34f5 <_fini+0x2f9>
    22da:	ba 07 00 00 00       	mov    $0x7,%edx
    22df:	4c 89 f7             	mov    %r14,%rdi
    22e2:	e8 59 f7 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    22fb:	e8 00 f7 ff ff       	callq  1a00 <_ZNSo9_M_insertIlEERSoT_@plt>
    2300:	48 8d 35 f6 11 00 00 	lea    0x11f6(%rip),%rsi        # 34fd <_fini+0x301>
    2307:	ba 05 00 00 00       	mov    $0x5,%edx
    230c:	48 89 c7             	mov    %rax,%rdi
    230f:	e8 2c f7 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2361:	e8 4a f6 ff ff       	callq  19b0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@plt>
    ...
    2395:	e8 76 f6 ff ff       	callq  1a10 <_Znwm@plt>
    ...
    23a7:	e8 44 f6 ff ff       	callq  19f0 <_ZdlPv@plt>
    ...
    23eb:	e8 d0 f5 ff ff       	callq  19c0 <memcpy@plt>
    ...
    241d:	e8 ce f5 ff ff       	callq  19f0 <_ZdlPv@plt>
    2422:	4c 89 6c 24 38       	mov    %r13,0x38(%rsp)
    2427:	48 8d 35 ec 10 00 00 	lea    0x10ec(%rip),%rsi        # 351a <_fini+0x31e>
    ...
    2466:	e8 e5 f5 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    248e:	48 8d 35 6e 10 00 00 	lea    0x106e(%rip),%rsi        # 3503 <_fini+0x307>
    2495:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    249a:	ba 12 00 00 00       	mov    $0x12,%edx
    249f:	e8 9c f5 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    24cd:	e8 7e f5 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    24f5:	e8 96 f5 ff ff       	callq  1a90 <getpid@plt>
    ...
    2516:	48 8d 1d 09 10 00 00 	lea    0x1009(%rip),%rbx        # 3526 <_fini+0x32a>
    251d:	4c 8d 3d 03 10 00 00 	lea    0x1003(%rip),%r15        # 3527 <_fini+0x32b>
    ...
    253c:	48 8d 35 4e 10 00 00 	lea    0x104e(%rip),%rsi        # 3591 <_fini+0x395>
    2543:	e8 f8 f4 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2573:	e8 d8 f4 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    25a1:	48 8d 35 6e 0f 00 00 	lea    0xf6e(%rip),%rsi        # 3516 <_fini+0x31a>
    25a8:	e8 93 f4 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    25ad:	ba 09 00 00 00       	mov    $0x9,%edx
    25b2:	4c 89 e7             	mov    %r12,%rdi
    25b5:	48 8d 35 60 0f 00 00 	lea    0xf60(%rip),%rsi        # 351c <_fini+0x320>
    ...
    25f3:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 352a <_fini+0x32e>
    25fa:	e8 41 f4 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2614:	e8 27 f4 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2631:	48 8d 35 fb 0e 00 00 	lea    0xefb(%rip),%rsi        # 3533 <_fini+0x337>
    2638:	e8 03 f4 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2670:	48 8d 35 c4 0e 00 00 	lea    0xec4(%rip),%rsi        # 353b <_fini+0x33f>
    2677:	e8 c4 f3 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    26a7:	48 8d 35 94 0e 00 00 	lea    0xe94(%rip),%rsi        # 3542 <_fini+0x346>
    ...
    26db:	48 8d 35 68 0e 00 00 	lea    0xe68(%rip),%rsi        # 354a <_fini+0x34e>
    ...
    270b:	48 8d 35 40 0e 00 00 	lea    0xe40(%rip),%rsi        # 3552 <_fini+0x356>
    ...
    273b:	48 8d 35 18 0e 00 00 	lea    0xe18(%rip),%rsi        # 355a <_fini+0x35e>
    ...
    274f:	48 8d 35 0e 0e 00 00 	lea    0xe0e(%rip),%rsi        # 3564 <_fini+0x368>
    ...
    2776:	48 8d 35 f2 0d 00 00 	lea    0xdf2(%rip),%rsi        # 356f <_fini+0x373>
    277d:	e8 be f2 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    279d:	48 8d 35 da 0d 00 00 	lea    0xdda(%rip),%rsi        # 357e <_fini+0x382>
    ...
    27c4:	48 8d 35 bc 0d 00 00 	lea    0xdbc(%rip),%rsi        # 3587 <_fini+0x38b>
    27cb:	e8 70 f2 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    27e5:	e8 56 f2 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    27ea:	ba 03 00 00 00       	mov    $0x3,%edx
    27ef:	4c 89 e7             	mov    %r12,%rdi
    27f2:	48 8d 35 8a 0d 00 00 	lea    0xd8a(%rip),%rsi        # 3583 <_fini+0x387>
    27f9:	e8 42 f2 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2815:	48 8d 35 6f 0d 00 00 	lea    0xd6f(%rip),%rsi        # 358b <_fini+0x38f>
    281c:	e8 1f f2 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2861:	e8 ea f1 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    288c:	48 8d 35 fb 0c 00 00 	lea    0xcfb(%rip),%rsi        # 358e <_fini+0x392>
    2893:	ba 04 00 00 00       	mov    $0x4,%edx
    2898:	48 89 c7             	mov    %rax,%rdi
    289b:	e8 a0 f1 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    28c9:	e8 82 f1 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    28ef:	48 8d 35 9d 0c 00 00 	lea    0xc9d(%rip),%rsi        # 3593 <_fini+0x397>
    28f6:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    28fb:	ba 0f 00 00 00       	mov    $0xf,%edx
    2900:	e8 3b f1 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2941:	48 8d 35 41 0c 00 00 	lea    0xc41(%rip),%rsi        # 3589 <_fini+0x38d>
    2948:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    294d:	ba 01 00 00 00       	mov    $0x1,%edx
    2952:	e8 e9 f0 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2980:	e8 cb f0 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    29a8:	48 8d 35 dd 0b 00 00 	lea    0xbdd(%rip),%rsi        # 358c <_fini+0x390>
    29af:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    29b4:	ba 01 00 00 00       	mov    $0x1,%edx
    29b9:	e8 82 f0 ff ff       	callq  1a40 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    29e7:	e8 64 f0 ff ff       	callq  1a50 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    2a69:	00 
    2a6a:	e8 11 f0 ff ff       	callq  1a80 <_ZNSt6localeD1Ev@plt>
    ...
    2ad7:	e8 14 ef ff ff       	callq  19f0 <_ZdlPv@plt>
    2adc:	48 89 9c 24 58 02 00 	mov    %rbx,0x258(%rsp)
    2ae3:	00 
    2ae4:	48 8d bc 24 90 02 00 	lea    0x290(%rsp),%rdi
    2aeb:	00 
    2aec:	e8 8f ef ff ff       	callq  1a80 <_ZNSt6localeD1Ev@plt>
    ...
    2b33:	e8 58 ee ff ff       	callq  1990 <pthread_mutex_unlock@plt>
    ...
    2b48:	5d                   	pop    %rbp
    2b49:	c3                   	retq   
    2b4a:	e8 11 ef ff ff       	callq  1a60 <_ZSt16__throw_bad_castv@plt>
    2b4f:	e8 0c ef ff ff       	callq  1a60 <_ZSt16__throw_bad_castv@plt>
    2b54:	e8 07 ef ff ff       	callq  1a60 <_ZSt16__throw_bad_castv@plt>
    2b59:	89 c7                	mov    %eax,%edi
    2b5b:	e8 f0 ed ff ff       	callq  1950 <_ZSt20__throw_system_errori@plt>
    2b60:	48 8d 3d 55 0a 00 00 	lea    0xa55(%rip),%rdi        # 35bc <_fini+0x3c0>
    ...
    2b83:	e8 68 ee ff ff       	callq  19f0 <_ZdlPv@plt>
    ...
    2ba2:	e8 09 ef ff ff       	callq  1ab0 <_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev@plt>
    2ba7:	4c 8b 64 24 08       	mov    0x8(%rsp),%r12
    2bac:	48 8d bc 24 40 02 00 	lea    0x240(%rsp),%rdi
    2bb3:	00 
    2bb4:	e8 c7 ed ff ff       	callq  1980 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev@plt>
    ...
    2bc6:	e8 c5 ed ff ff       	callq  1990 <pthread_mutex_unlock@plt>
...
0000000000002be0 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii>:
    ...
    2c10:	e8 8b ee ff ff       	callq  1aa0 <pthread_mutex_lock@plt>
    ...
    2cf6:	e8 95 ec ff ff       	callq  1990 <pthread_mutex_unlock@plt>
    ...
    2d65:	e8 a6 ec ff ff       	callq  1a10 <_Znwm@plt>
    ...
    2dd8:	e8 13 ec ff ff       	callq  19f0 <_ZdlPv@plt>
    ...
    2e25:	e8 66 eb ff ff       	callq  1990 <pthread_mutex_unlock@plt>
...
0000000000002e40 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2e97:	e8 d4 eb ff ff       	callq  1a70 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm@plt>
    ...
    2f1a:	e8 a1 ea ff ff       	callq  19c0 <memcpy@plt>
...
00000000000030a0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    310b:	e8 00 e9 ff ff       	callq  1a10 <_Znwm@plt>
    ...
    3133:	e8 88 e8 ff ff       	callq  19c0 <memcpy@plt>
    ...
    3176:	e8 45 e8 ff ff       	callq  19c0 <memcpy@plt>
    ...
    31bb:	e8 30 e8 ff ff       	callq  19f0 <_ZdlPv@plt>
    ...
    31de:	e8 dd e7 ff ff       	callq  19c0 <memcpy@plt>
    ...
    31ef:	48 8d 3d c6 03 00 00 	lea    0x3c6(%rip),%rdi        # 35bc <_fini+0x3c0>
