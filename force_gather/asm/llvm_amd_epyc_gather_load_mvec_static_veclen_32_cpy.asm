...
0000000000001a90 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d@plt>:
    1a90:	ff 25 aa 26 20 00    	jmpq   *0x2026aa(%rip)        # 204140 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d@@Base+0x202520>
...
0000000000001c20 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d>:
    1c20:	41 57                	push   %r15
    1c22:	41 56                	push   %r14
    1c24:	53                   	push   %rbx
    ...
    1c60:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1d50 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1c9c:	74 07                	je     1ca5 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d+0x85>
    1c9e:	e8 ed fc ff ff       	callq  1990 <pthread_self@plt>
    1ca3:	eb 05                	jmp    1caa <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d+0x8a>
    ...
    1cfc:	48 8d 35 3e 15 00 00 	lea    0x153e(%rip),%rsi        # 3241 <_fini+0x1e5>
    1d03:	48 8d 15 62 15 00 00 	lea    0x1562(%rip),%rdx        # 326c <_fini+0x210>
    ...
    1d20:	48 8d 35 4b 15 00 00 	lea    0x154b(%rip),%rsi        # 3272 <_fini+0x216>
    1d27:	48 8d 15 7a 15 00 00 	lea    0x157a(%rip),%rdx        # 32a8 <_fini+0x24c>
    ...
    1d40:	e8 fb 02 00 00       	callq  2040 <__clang_call_terminate>
    1d45:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d4c:	00 00 00 00 

0000000000001d50 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined>:
    1d50:	55                   	push   %rbp
    1d51:	41 57                	push   %r15
    1d53:	41 56                	push   %r14
    1d55:	53                   	push   %rbx
    ...
    1d6c:	00 
    1d6d:	c7 44 24 08 ff ff 11 	movl   $0x11ffff,0x8(%rsp)
    1d74:	00 
    ...
    1daf:	50                   	push   %rax
    1db0:	e8 bb fc ff ff       	callq  1a70 <__kmpc_for_static_init_4@plt>
    1db5:	48 83 c4 20          	add    $0x20,%rsp
    1db9:	8b 4c 24 08          	mov    0x8(%rsp),%ecx
    1dbd:	48 63 74 24 0c       	movslq 0xc(%rsp),%rsi
    1dc2:	b8 ff ff 11 00       	mov    $0x11ffff,%eax
    1dc7:	81 f9 ff ff 11 00    	cmp    $0x11ffff,%ecx
    1dcd:	0f 4c c1             	cmovl  %ecx,%eax
    1dd0:	89 44 24 08          	mov    %eax,0x8(%rsp)
    1dd4:	39 c6                	cmp    %eax,%esi
    1dd6:	0f 8f 20 01 00 00    	jg     1efc <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined+0x1ac>
    1ddc:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
    1de1:	48 89 f2             	mov    %rsi,%rdx
    1de4:	29 f0                	sub    %esi,%eax
    1de6:	48 c1 e2 08          	shl    $0x8,%rdx
    1dea:	ff c0                	inc    %eax
    1dec:	0f 1f 40 00          	nopl   0x0(%rax)
    1df0:	49 8b 3e             	mov    (%r14),%rdi
    1df3:	49 8b 37             	mov    (%r15),%rsi
    1df6:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1dfa:	c5 e5 76 db          	vpcmpeqd %ymm3,%ymm3,%ymm3
    1dfe:	c5 dd 76 e4          	vpcmpeqd %ymm4,%ymm4,%ymm4
    ...
    1e1d:	c4 e2 7d 19 03       	vbroadcastsd (%rbx),%ymm0
    1e22:	c5 f8 10 0c 17       	vmovups (%rdi,%rdx,1),%xmm1
    1e27:	c5 f0 c6 4c 17 10 88 	vshufps $0x88,0x10(%rdi,%rdx,1),%xmm1,%xmm1
    1e2e:	c4 e2 e5 92 94 8e e0 	vgatherdpd %ymm3,0xe0(%rsi,%xmm1,4),%ymm2
    1e35:	00 00 00 
    1e38:	c5 e1 57 db          	vxorpd %xmm3,%xmm3,%xmm3
    1e3c:	c4 e2 dd 92 9c 8e c0 	vgatherdpd %ymm4,0xc0(%rsi,%xmm1,4),%ymm3
    1e43:	00 00 00 
    1e46:	c5 d9 57 e4          	vxorpd %xmm4,%xmm4,%xmm4
    1e4a:	c4 e2 d5 92 a4 8e a0 	vgatherdpd %ymm5,0xa0(%rsi,%xmm1,4),%ymm4
    1e51:	00 00 00 
    1e54:	c5 d1 57 ed          	vxorpd %xmm5,%xmm5,%xmm5
    1e58:	c4 e2 cd 92 ac 8e 80 	vgatherdpd %ymm6,0x80(%rsi,%xmm1,4),%ymm5
    1e5f:	00 00 00 
    1e62:	c5 c9 57 f6          	vxorpd %xmm6,%xmm6,%xmm6
    1e66:	c4 e2 c5 92 74 8e 60 	vgatherdpd %ymm7,0x60(%rsi,%xmm1,4),%ymm6
    1e6d:	c5 c1 57 ff          	vxorpd %xmm7,%xmm7,%xmm7
    1e71:	c4 e2 bd 92 7c 8e 40 	vgatherdpd %ymm8,0x40(%rsi,%xmm1,4),%ymm7
    1e78:	c4 41 39 57 c0       	vxorpd %xmm8,%xmm8,%xmm8
    1e7d:	c4 62 b5 92 44 8e 20 	vgatherdpd %ymm9,0x20(%rsi,%xmm1,4),%ymm8
    1e84:	c4 41 31 57 c9       	vxorpd %xmm9,%xmm9,%xmm9
    1e89:	c4 62 ad 92 0c 8e    	vgatherdpd %ymm10,(%rsi,%xmm1,4),%ymm9
    1e8f:	48 8b 31             	mov    (%rcx),%rsi
    1e92:	c5 e5 59 d8          	vmulpd %ymm0,%ymm3,%ymm3
    1e96:	c5 dd 59 e0          	vmulpd %ymm0,%ymm4,%ymm4
    1e9a:	c5 d5 59 e8          	vmulpd %ymm0,%ymm5,%ymm5
    1e9e:	c5 cd 59 f0          	vmulpd %ymm0,%ymm6,%ymm6
    1ea2:	c5 c5 59 f8          	vmulpd %ymm0,%ymm7,%ymm7
    1ea6:	c5 3d 59 c0          	vmulpd %ymm0,%ymm8,%ymm8
    1eaa:	c5 b5 59 c8          	vmulpd %ymm0,%ymm9,%ymm1
    1eae:	c5 ed 59 c0          	vmulpd %ymm0,%ymm2,%ymm0
    1eb2:	c5 fd 11 0c 16       	vmovupd %ymm1,(%rsi,%rdx,1)
    1eb7:	c5 7d 11 44 16 20    	vmovupd %ymm8,0x20(%rsi,%rdx,1)
    1ebd:	c5 fd 11 7c 16 40    	vmovupd %ymm7,0x40(%rsi,%rdx,1)
    1ec3:	c5 fd 11 74 16 60    	vmovupd %ymm6,0x60(%rsi,%rdx,1)
    1ec9:	c5 fd 11 ac 16 80 00 	vmovupd %ymm5,0x80(%rsi,%rdx,1)
    1ed0:	00 00 
    1ed2:	c5 fd 11 a4 16 a0 00 	vmovupd %ymm4,0xa0(%rsi,%rdx,1)
    1ed9:	00 00 
    1edb:	c5 fd 11 9c 16 c0 00 	vmovupd %ymm3,0xc0(%rsi,%rdx,1)
    1ee2:	00 00 
    1ee4:	c5 fd 11 84 16 e0 00 	vmovupd %ymm0,0xe0(%rsi,%rdx,1)
    1eeb:	00 00 
    1eed:	48 81 c2 00 01 00 00 	add    $0x100,%rdx
    1ef4:	ff c8                	dec    %eax
    1ef6:	0f 85 f4 fe ff ff    	jne    1df0 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d.omp_outlined+0xa0>
    1efc:	48 8d 3d 5d 1e 20 00 	lea    0x201e5d(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1f03:	89 ee                	mov    %ebp,%esi
    1f05:	c5 f8 77             	vzeroupper 
    1f08:	e8 43 f9 ff ff       	callq  1850 <__kmpc_for_static_fini@plt>
    1f0d:	48 83 c4 18          	add    $0x18,%rsp
    1f11:	5b                   	pop    %rbx
    1f12:	41 5e                	pop    %r14
    1f14:	41 5f                	pop    %r15
    1f16:	5d                   	pop    %rbp
...
0000000000001f20 <__program_gather_load_mvec_static_veclen_32_cpy>:
    1f20:	e9 6b fb ff ff       	jmpq   1a90 <_Z56__program_gather_load_mvec_static_veclen_32_cpy_internalP45gather_load_mvec_static_veclen_32_cpy_state_tPdPlS1_d@plt>
    1f25:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1f2c:	00 00 00 00 

0000000000001f30 <__dace_init_gather_load_mvec_static_veclen_32_cpy>:
    1f30:	50                   	push   %rax
...
0000000000001f50 <__dace_exit_gather_load_mvec_static_veclen_32_cpy>:
    1f50:	48 85 ff             	test   %rdi,%rdi
    1f53:	74 23                	je     1f78 <__dace_exit_gather_load_mvec_static_veclen_32_cpy+0x28>
    1f55:	53                   	push   %rbx
    1f56:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f5a:	48 85 c0             	test   %rax,%rax
    1f5d:	74 0e                	je     1f6d <__dace_exit_gather_load_mvec_static_veclen_32_cpy+0x1d>
...
0000000000002050 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    20ef:	48 8d 35 f3 11 00 00 	lea    0x11f3(%rip),%rsi        # 32e9 <_fini+0x28d>
    ...
    2103:	48 8d 35 e1 11 00 00 	lea    0x11e1(%rip),%rsi        # 32eb <_fini+0x28f>
    ...
    2130:	48 8d 35 bc 11 00 00 	lea    0x11bc(%rip),%rsi        # 32f3 <_fini+0x297>
    ...
    2252:	48 8d 35 b7 10 00 00 	lea    0x10b7(%rip),%rsi        # 3310 <_fini+0x2b4>
    ...
    22be:	48 8d 35 34 10 00 00 	lea    0x1034(%rip),%rsi        # 32f9 <_fini+0x29d>
    ...
    2346:	48 8d 1d cf 0f 00 00 	lea    0xfcf(%rip),%rbx        # 331c <_fini+0x2c0>
    234d:	4c 8d 3d c9 0f 00 00 	lea    0xfc9(%rip),%r15        # 331d <_fini+0x2c1>
    ...
    236c:	48 8d 35 14 10 00 00 	lea    0x1014(%rip),%rsi        # 3387 <_fini+0x32b>
    ...
    23d1:	48 8d 35 34 0f 00 00 	lea    0xf34(%rip),%rsi        # 330c <_fini+0x2b0>
    ...
    23e5:	48 8d 35 26 0f 00 00 	lea    0xf26(%rip),%rsi        # 3312 <_fini+0x2b6>
    ...
    2423:	48 8d 35 f6 0e 00 00 	lea    0xef6(%rip),%rsi        # 3320 <_fini+0x2c4>
    ...
    2461:	48 8d 35 c1 0e 00 00 	lea    0xec1(%rip),%rsi        # 3329 <_fini+0x2cd>
    ...
    24a0:	48 8d 35 8a 0e 00 00 	lea    0xe8a(%rip),%rsi        # 3331 <_fini+0x2d5>
    ...
    24d7:	48 8d 35 5a 0e 00 00 	lea    0xe5a(%rip),%rsi        # 3338 <_fini+0x2dc>
    ...
    250b:	48 8d 35 2e 0e 00 00 	lea    0xe2e(%rip),%rsi        # 3340 <_fini+0x2e4>
    ...
    253b:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 3348 <_fini+0x2ec>
    ...
    256b:	48 8d 35 de 0d 00 00 	lea    0xdde(%rip),%rsi        # 3350 <_fini+0x2f4>
    ...
    257f:	48 8d 35 d4 0d 00 00 	lea    0xdd4(%rip),%rsi        # 335a <_fini+0x2fe>
    ...
    25a6:	48 8d 35 b8 0d 00 00 	lea    0xdb8(%rip),%rsi        # 3365 <_fini+0x309>
    ...
    25cd:	48 8d 35 a0 0d 00 00 	lea    0xda0(%rip),%rsi        # 3374 <_fini+0x318>
    ...
    25f4:	48 8d 35 82 0d 00 00 	lea    0xd82(%rip),%rsi        # 337d <_fini+0x321>
    ...
    2622:	48 8d 35 50 0d 00 00 	lea    0xd50(%rip),%rsi        # 3379 <_fini+0x31d>
    ...
    2645:	48 8d 35 35 0d 00 00 	lea    0xd35(%rip),%rsi        # 3381 <_fini+0x325>
    ...
    26b9:	48 8d 35 c4 0c 00 00 	lea    0xcc4(%rip),%rsi        # 3384 <_fini+0x328>
    ...
    271f:	48 8d 35 63 0c 00 00 	lea    0xc63(%rip),%rsi        # 3389 <_fini+0x32d>
    ...
    276e:	48 8d 35 0a 0c 00 00 	lea    0xc0a(%rip),%rsi        # 337f <_fini+0x323>
    ...
    27d5:	48 8d 35 a6 0b 00 00 	lea    0xba6(%rip),%rsi        # 3382 <_fini+0x326>
    ...
    298d:	48 8d 3d 1e 0a 00 00 	lea    0xa1e(%rip),%rdi        # 33b2 <_fini+0x356>
...
0000000000002ca0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2ef3:	48 8d 3d 9f 04 00 00 	lea    0x49f(%rip),%rdi        # 3399 <_fini+0x33d>
...
0000000000002f00 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    304f:	48 8d 3d 5c 03 00 00 	lea    0x35c(%rip),%rdi        # 33b2 <_fini+0x356>
