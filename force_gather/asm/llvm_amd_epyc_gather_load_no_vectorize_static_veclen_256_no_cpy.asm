...
0000000000001930 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d@plt>:
    1930:	ff 25 32 27 20 00    	jmpq   *0x202732(%rip)        # 204068 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d@@Base+0x2023f8>
...
00000000000019c0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@plt>:
    19c0:	ff 25 ea 26 20 00    	jmpq   *0x2026ea(%rip)        # 2040b0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@@Base+0x2013d0>
...
0000000000001c70 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d>:
    1c70:	41 57                	push   %r15
    1c72:	41 56                	push   %r14
    1c74:	53                   	push   %rbx
    ...
    1cb0:	48 8d 15 e9 00 00 00 	lea    0xe9(%rip),%rdx        # 1da0 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined>
    ...
    1cec:	74 07                	je     1cf5 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d+0x85>
    1cee:	e8 fd fc ff ff       	callq  19f0 <pthread_self@plt>
    1cf3:	eb 05                	jmp    1cfa <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d+0x8a>
    ...
    1d4c:	48 8d 35 76 15 00 00 	lea    0x1576(%rip),%rsi        # 32c9 <_fini+0x22d>
    1d53:	48 8d 15 a6 15 00 00 	lea    0x15a6(%rip),%rdx        # 3300 <_fini+0x264>
    ...
    1d70:	48 8d 35 8f 15 00 00 	lea    0x158f(%rip),%rsi        # 3306 <_fini+0x26a>
    1d77:	48 8d 15 ca 15 00 00 	lea    0x15ca(%rip),%rdx        # 3348 <_fini+0x2ac>
    ...
    1d90:	e8 eb 02 00 00       	callq  2080 <__clang_call_terminate>
    1d95:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1d9c:	00 00 00 00 

0000000000001da0 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined>:
    1da0:	55                   	push   %rbp
    ...
    1db1:	48 81 ec 80 10 00 00 	sub    $0x1080,%rsp
    1db8:	8b 37                	mov    (%rdi),%esi
    1dba:	4d 89 c7             	mov    %r8,%r15
    1dbd:	49 89 cc             	mov    %rcx,%r12
    1dc0:	4c 89 4c 24 38       	mov    %r9,0x38(%rsp)
    1dc5:	c7 44 24 28 00 00 00 	movl   $0x0,0x28(%rsp)
    1dcc:	00 
    1dcd:	c7 44 24 24 ff 3f 02 	movl   $0x23fff,0x24(%rsp)
    1dd4:	00 
    1dd5:	c7 44 24 34 01 00 00 	movl   $0x1,0x34(%rsp)
    1ddc:	00 
    1ddd:	c7 44 24 30 00 00 00 	movl   $0x0,0x30(%rsp)
    1de4:	00 
    1de5:	48 83 ec 08          	sub    $0x8,%rsp
    1de9:	48 8d 44 24 3c       	lea    0x3c(%rsp),%rax
    1dee:	48 8d 3d 53 1f 20 00 	lea    0x201f53(%rip),%rdi        # 203d48 <__dso_handle+0x8>
    1df5:	48 8d 4c 24 38       	lea    0x38(%rsp),%rcx
    1dfa:	4c 8d 44 24 30       	lea    0x30(%rsp),%r8
    1dff:	4c 8d 4c 24 2c       	lea    0x2c(%rsp),%r9
    1e04:	89 74 24 34          	mov    %esi,0x34(%rsp)
    1e08:	ba 22 00 00 00       	mov    $0x22,%edx
    1e0d:	6a 01                	pushq  $0x1
    1e0f:	6a 01                	pushq  $0x1
    1e11:	50                   	push   %rax
    1e12:	e8 b9 fc ff ff       	callq  1ad0 <__kmpc_for_static_init_4@plt>
    1e17:	48 83 c4 20          	add    $0x20,%rsp
    1e1b:	8b 44 24 24          	mov    0x24(%rsp),%eax
    1e1f:	4c 63 74 24 28       	movslq 0x28(%rsp),%r14
    1e24:	41 bd ff 3f 02 00    	mov    $0x23fff,%r13d
    1e2a:	3d ff 3f 02 00       	cmp    $0x23fff,%eax
    1e2f:	44 0f 4c e8          	cmovl  %eax,%r13d
    1e33:	44 89 6c 24 24       	mov    %r13d,0x24(%rsp)
    1e38:	45 39 ee             	cmp    %r13d,%r14d
    1e3b:	0f 8f fc 00 00 00    	jg     1f3d <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0x19d>
    1e41:	48 8b 45 10          	mov    0x10(%rbp),%rax
    1e45:	4d 8b 24 24          	mov    (%r12),%r12
    1e49:	4d 8b 3f             	mov    (%r15),%r15
    1e4c:	41 ff c5             	inc    %r13d
    1e4f:	48 8b 18             	mov    (%rax),%rbx
    1e52:	66 66 66 66 66 2e 0f 	data16 data16 data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1e59:	1f 84 00 00 00 00 00 
    1e60:	4c 89 f1             	mov    %r14,%rcx
    1e63:	4c 89 f0             	mov    %r14,%rax
    1e66:	4c 89 e2             	mov    %r12,%rdx
    1e69:	48 c1 e1 0b          	shl    $0xb,%rcx
    1e6d:	48 c1 e0 08          	shl    $0x8,%rax
    1e71:	c4 c1 78 10 04 0f    	vmovups (%r15,%rcx,1),%xmm0
    1e77:	c4 c1 78 c6 44 0f 10 	vshufps $0x88,0x10(%r15,%rcx,1),%xmm0,%xmm0
    1e7e:	88 
    1e7f:	48 c7 c1 fc ff ff ff 	mov    $0xfffffffffffffffc,%rcx
    1e86:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    1e8d:	00 00 00 
    1e90:	c5 f5 76 c9          	vpcmpeqd %ymm1,%ymm1,%ymm1
    1e94:	c5 e9 57 d2          	vxorpd %xmm2,%xmm2,%xmm2
    1e98:	c4 e2 f5 92 14 82    	vgatherdpd %ymm1,(%rdx,%xmm0,4),%ymm2
    1e9e:	48 83 c2 20          	add    $0x20,%rdx
    1ea2:	c5 fd 29 54 cc 60    	vmovapd %ymm2,0x60(%rsp,%rcx,8)
    1ea8:	48 83 c1 04          	add    $0x4,%rcx
    1eac:	48 81 f9 fc 00 00 00 	cmp    $0xfc,%rcx
    1eb3:	72 db                	jb     1e90 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0xf0>
    1eb5:	48 8b 4c 24 38       	mov    0x38(%rsp),%rcx
    1eba:	c4 e2 7d 19 01       	vbroadcastsd (%rcx),%ymm0
    1ebf:	b9 0c 00 00 00       	mov    $0xc,%ecx
    1ec4:	66 66 66 2e 0f 1f 84 	data16 data16 nopw %cs:0x0(%rax,%rax,1)
    1ecb:	00 00 00 00 00 
    1ed0:	c5 fd 59 4c cc e0    	vmulpd -0x20(%rsp,%rcx,8),%ymm0,%ymm1
    1ed6:	c5 fd 59 14 cc       	vmulpd (%rsp,%rcx,8),%ymm0,%ymm2
    1edb:	c5 fd 59 5c cc 20    	vmulpd 0x20(%rsp,%rcx,8),%ymm0,%ymm3
    1ee1:	c5 fd 59 64 cc 40    	vmulpd 0x40(%rsp,%rcx,8),%ymm0,%ymm4
    1ee7:	c5 fd 29 8c cc e0 07 	vmovapd %ymm1,0x7e0(%rsp,%rcx,8)
    1eee:	00 00 
    1ef0:	c5 fd 29 94 cc 00 08 	vmovapd %ymm2,0x800(%rsp,%rcx,8)
    1ef7:	00 00 
    1ef9:	c5 fd 29 9c cc 20 08 	vmovapd %ymm3,0x820(%rsp,%rcx,8)
    1f00:	00 00 
    1f02:	c5 fd 29 a4 cc 40 08 	vmovapd %ymm4,0x840(%rsp,%rcx,8)
    1f09:	00 00 
    1f0b:	48 83 c1 10          	add    $0x10,%rcx
    1f0f:	48 81 f9 0c 01 00 00 	cmp    $0x10c,%rcx
    1f16:	75 b8                	jne    1ed0 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0x130>
    1f18:	48 8d 3c c3          	lea    (%rbx,%rax,8),%rdi
    1f1c:	ba 00 08 00 00       	mov    $0x800,%edx
    1f21:	48 8d b4 24 40 08 00 	lea    0x840(%rsp),%rsi
    1f28:	00 
    1f29:	c5 f8 77             	vzeroupper 
    1f2c:	e8 9f fa ff ff       	callq  19d0 <memcpy@plt>
    1f31:	49 ff c6             	inc    %r14
    1f34:	45 39 f5             	cmp    %r14d,%r13d
    1f37:	0f 85 23 ff ff ff    	jne    1e60 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d.omp_outlined+0xc0>
    1f3d:	8b 74 24 2c          	mov    0x2c(%rsp),%esi
    1f41:	48 8d 3d 18 1e 20 00 	lea    0x201e18(%rip),%rdi        # 203d60 <__dso_handle+0x20>
    1f48:	e8 53 f9 ff ff       	callq  18a0 <__kmpc_for_static_fini@plt>
    1f4d:	48 8d 65 d8          	lea    -0x28(%rbp),%rsp
    1f51:	5b                   	pop    %rbx
    1f52:	41 5c                	pop    %r12
    1f54:	41 5d                	pop    %r13
    1f56:	41 5e                	pop    %r14
...
0000000000001f60 <__program_gather_load_no_vectorize_static_veclen_256_no_cpy>:
    1f60:	e9 cb f9 ff ff       	jmpq   1930 <_Z68__program_gather_load_no_vectorize_static_veclen_256_no_cpy_internalP57gather_load_no_vectorize_static_veclen_256_no_cpy_state_tPdPlS1_d@plt>
    1f65:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    1f6c:	00 00 00 00 

0000000000001f70 <__dace_init_gather_load_no_vectorize_static_veclen_256_no_cpy>:
    1f70:	50                   	push   %rax
...
0000000000001f90 <__dace_exit_gather_load_no_vectorize_static_veclen_256_no_cpy>:
    1f90:	48 85 ff             	test   %rdi,%rdi
    1f93:	74 23                	je     1fb8 <__dace_exit_gather_load_no_vectorize_static_veclen_256_no_cpy+0x28>
    1f95:	53                   	push   %rbx
    1f96:	48 8b 47 28          	mov    0x28(%rdi),%rax
    1f9a:	48 85 c0             	test   %rax,%rax
    1f9d:	74 0e                	je     1fad <__dace_exit_gather_load_no_vectorize_static_veclen_256_no_cpy+0x1d>
...
0000000000001fc0 <_ZN4dace4perf6Report5resetEv>:
    ...
    204b:	5b                   	pop    %rbx
    204c:	41 5e                	pop    %r14
    204e:	e9 4d f9 ff ff       	jmpq   19a0 <pthread_mutex_unlock@plt>
    2053:	48 83 c4 08          	add    $0x8,%rsp
    2057:	5b                   	pop    %rbx
    2058:	41 5e                	pop    %r14
    205a:	c3                   	retq   
    205b:	89 c7                	mov    %eax,%edi
    205d:	e8 fe f8 ff ff       	callq  1960 <_ZSt20__throw_system_errori@plt>
    ...
    2072:	e8 29 f9 ff ff       	callq  19a0 <pthread_mutex_unlock@plt>
...
0000000000002090 <_ZN4dace4perf6Report4saveEPKcS3_>:
    ...
    20d1:	e8 da f8 ff ff       	callq  19b0 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEC1ESt13_Ios_Openmode@plt>
    ...
    212f:	48 8d 35 53 12 00 00 	lea    0x1253(%rip),%rsi        # 3389 <_fini+0x2ed>
    ...
    2143:	48 8d 35 41 12 00 00 	lea    0x1241(%rip),%rsi        # 338b <_fini+0x2ef>
    ...
    2170:	48 8d 35 1c 12 00 00 	lea    0x121c(%rip),%rsi        # 3393 <_fini+0x2f7>
    ...
    21d1:	e8 ea f7 ff ff       	callq  19c0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm@plt>
    ...
    225b:	e8 70 f7 ff ff       	callq  19d0 <memcpy@plt>
    ...
    2292:	48 8d 35 17 11 00 00 	lea    0x1117(%rip),%rsi        # 33b0 <_fini+0x314>
    ...
    22f9:	e8 82 f6 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    22fe:	48 8d 35 94 10 00 00 	lea    0x1094(%rip),%rsi        # 3399 <_fini+0x2fd>
    ...
    2360:	e8 1b f6 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    ...
    2386:	48 8d 1d 2f 10 00 00 	lea    0x102f(%rip),%rbx        # 33bc <_fini+0x320>
    238d:	4c 8d 3d 29 10 00 00 	lea    0x1029(%rip),%r15        # 33bd <_fini+0x321>
    ...
    23ac:	48 8d 35 74 10 00 00 	lea    0x1074(%rip),%rsi        # 3427 <_fini+0x38b>
    ...
    2404:	e8 77 f5 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    2409:	ba 05 00 00 00       	mov    $0x5,%edx
    240e:	4c 89 e7             	mov    %r12,%rdi
    2411:	48 8d 35 94 0f 00 00 	lea    0xf94(%rip),%rsi        # 33ac <_fini+0x310>
    ...
    2425:	48 8d 35 86 0f 00 00 	lea    0xf86(%rip),%rsi        # 33b2 <_fini+0x316>
    ...
    2463:	48 8d 35 56 0f 00 00 	lea    0xf56(%rip),%rsi        # 33c0 <_fini+0x324>
    ...
    24a1:	48 8d 35 21 0f 00 00 	lea    0xf21(%rip),%rsi        # 33c9 <_fini+0x32d>
    ...
    24e0:	48 8d 35 ea 0e 00 00 	lea    0xeea(%rip),%rsi        # 33d1 <_fini+0x335>
    ...
    24f3:	e8 78 f4 ff ff       	callq  1970 <_ZNSo9_M_insertImEERSoT_@plt>
    ...
    2517:	48 8d 35 ba 0e 00 00 	lea    0xeba(%rip),%rsi        # 33d8 <_fini+0x33c>
    ...
    254b:	48 8d 35 8e 0e 00 00 	lea    0xe8e(%rip),%rsi        # 33e0 <_fini+0x344>
    ...
    257b:	48 8d 35 66 0e 00 00 	lea    0xe66(%rip),%rsi        # 33e8 <_fini+0x34c>
    ...
    25ab:	48 8d 35 3e 0e 00 00 	lea    0xe3e(%rip),%rsi        # 33f0 <_fini+0x354>
    ...
    25bf:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 33fa <_fini+0x35e>
    ...
    25e6:	48 8d 35 18 0e 00 00 	lea    0xe18(%rip),%rsi        # 3405 <_fini+0x369>
    ...
    260d:	48 8d 35 00 0e 00 00 	lea    0xe00(%rip),%rsi        # 3414 <_fini+0x378>
    ...
    2634:	48 8d 35 e2 0d 00 00 	lea    0xde2(%rip),%rsi        # 341d <_fini+0x381>
    ...
    2662:	48 8d 35 b0 0d 00 00 	lea    0xdb0(%rip),%rsi        # 3419 <_fini+0x37d>
    ...
    2678:	e8 f3 f2 ff ff       	callq  1970 <_ZNSo9_M_insertImEERSoT_@plt>
    267d:	ba 02 00 00 00       	mov    $0x2,%edx
    2682:	4c 89 e7             	mov    %r12,%rdi
    2685:	48 8d 35 95 0d 00 00 	lea    0xd95(%rip),%rsi        # 3421 <_fini+0x385>
    ...
    26f4:	e8 87 f2 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    26f9:	48 8d 35 24 0d 00 00 	lea    0xd24(%rip),%rsi        # 3424 <_fini+0x388>
    ...
    275a:	e8 21 f2 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    275f:	48 8d 35 c3 0c 00 00 	lea    0xcc3(%rip),%rsi        # 3429 <_fini+0x38d>
    ...
    27a9:	e8 52 f3 ff ff       	callq  1b00 <_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate@plt>
    27ae:	48 8d 35 6a 0c 00 00 	lea    0xc6a(%rip),%rsi        # 341f <_fini+0x383>
    27b5:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    27ba:	ba 01 00 00 00       	mov    $0x1,%edx
    27bf:	e8 8c f2 ff ff       	callq  1a50 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    27ed:	e8 6e f2 ff ff       	callq  1a60 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    2808:	e8 83 f0 ff ff       	callq  1890 <_ZNSo3putEc@plt>
    280d:	48 89 c7             	mov    %rax,%rdi
    2810:	e8 6b f1 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    2815:	48 8d 35 06 0c 00 00 	lea    0xc06(%rip),%rsi        # 3422 <_fini+0x386>
    281c:	48 8d 7c 24 40       	lea    0x40(%rsp),%rdi
    2821:	ba 01 00 00 00       	mov    $0x1,%edx
    2826:	e8 25 f2 ff ff       	callq  1a50 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    ...
    2854:	e8 07 f2 ff ff       	callq  1a60 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    ...
    286f:	e8 1c f0 ff ff       	callq  1890 <_ZNSo3putEc@plt>
    2874:	48 89 c7             	mov    %rax,%rdi
    2877:	e8 04 f1 ff ff       	callq  1980 <_ZNSo5flushEv@plt>
    ...
    28ad:	e8 1e f0 ff ff       	callq  18d0 <_ZNSt13basic_filebufIcSt11char_traitsIcEE5closeEv@plt>
    28b2:	48 8d bc 24 b0 00 00 	lea    0xb0(%rsp),%rdi
    28b9:	00 
    28ba:	e8 71 f2 ff ff       	callq  1b30 <_ZNSt12__basic_fileIcED1Ev@plt>
    ...
    28d7:	e8 b4 f1 ff ff       	callq  1a90 <_ZNSt6localeD1Ev@plt>
    28dc:	48 8d bc 24 38 01 00 	lea    0x138(%rsp),%rdi
    28e3:	00 
    28e4:	e8 07 f0 ff ff       	callq  18f0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    2944:	e8 b7 f0 ff ff       	callq  1a00 <_ZdlPv@plt>
    2949:	48 8d bc 24 90 02 00 	lea    0x290(%rsp),%rdi
    2950:	00 
    2951:	48 89 9c 24 58 02 00 	mov    %rbx,0x258(%rsp)
    2958:	00 
    2959:	e8 32 f1 ff ff       	callq  1a90 <_ZNSt6localeD1Ev@plt>
    ...
    2989:	00 00 00 00 00 
    298e:	e8 5d ef ff ff       	callq  18f0 <_ZNSt8ios_baseD2Ev@plt>
    ...
    29a0:	e8 fb ef ff ff       	callq  19a0 <pthread_mutex_unlock@plt>
    ...
    29b5:	5d                   	pop    %rbp
    29b6:	c3                   	retq   
    29b7:	e8 b4 f0 ff ff       	callq  1a70 <_ZSt16__throw_bad_castv@plt>
    29bc:	e8 af f0 ff ff       	callq  1a70 <_ZSt16__throw_bad_castv@plt>
    29c1:	e8 aa f0 ff ff       	callq  1a70 <_ZSt16__throw_bad_castv@plt>
    29c6:	89 c7                	mov    %eax,%edi
    29c8:	e8 93 ef ff ff       	callq  1960 <_ZSt20__throw_system_errori@plt>
    29cd:	48 8d 3d 7e 0a 00 00 	lea    0xa7e(%rip),%rdi        # 3452 <_fini+0x3b6>
    29d4:	e8 77 ef ff ff       	callq  1950 <_ZSt20__throw_length_errorPKc@plt>
    ...
    29f0:	e8 0b f0 ff ff       	callq  1a00 <_ZdlPv@plt>
    ...
    2a0f:	e8 ac f0 ff ff       	callq  1ac0 <_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev@plt>
    2a14:	4c 8b 64 24 08       	mov    0x8(%rsp),%r12
    2a19:	48 8d bc 24 40 02 00 	lea    0x240(%rsp),%rdi
    2a20:	00 
    2a21:	e8 6a ef ff ff       	callq  1990 <_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev@plt>
    ...
    2a33:	e8 68 ef ff ff       	callq  19a0 <pthread_mutex_unlock@plt>
    2a38:	48 89 df             	mov    %rbx,%rdi
    2a3b:	e8 e0 f0 ff ff       	callq  1b20 <_Unwind_Resume@plt>
...
0000000000002a40 <_ZN4dace4perf6Report14add_completionEPKcS3_mmmiii>:
    ...
    2b82:	e8 19 ee ff ff       	callq  19a0 <pthread_mutex_unlock@plt>
    ...
    2bf1:	e8 2a ee ff ff       	callq  1a20 <_Znwm@plt>
    ...
    2c6e:	e8 6d ee ff ff       	callq  1ae0 <memmove@plt>
    ...
    2c85:	e8 76 ed ff ff       	callq  1a00 <_ZdlPv@plt>
    ...
    2cb7:	e8 a4 ec ff ff       	callq  1960 <_ZSt20__throw_system_errori@plt>
    ...
    2ccc:	e8 cf ec ff ff       	callq  19a0 <pthread_mutex_unlock@plt>
    2cd1:	4c 89 f7             	mov    %r14,%rdi
    2cd4:	e8 47 ee ff ff       	callq  1b20 <_Unwind_Resume@plt>
...
0000000000002ce0 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm>:
    ...
    2f33:	48 8d 3d ff 04 00 00 	lea    0x4ff(%rip),%rdi        # 3439 <_fini+0x39d>
...
0000000000002f40 <_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm>:
    ...
    308f:	48 8d 3d bc 03 00 00 	lea    0x3bc(%rip),%rdi        # 3452 <_fini+0x3b6>
