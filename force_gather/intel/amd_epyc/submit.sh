#!/bin/bash
#SBATCH --job-name=gather_amd_epyc_intel  # Job name
...
configs=(
    ...
    "-qopt-zmm-usage=high -diag-enable=vec -qopt-report=5 -qopt-report-phase=vec -qopt-report-file=${SCRIPT_DIR}/force_gather_vec_report.optrpt" "force_width_512"
    "-no-vec" "no_vectorize"
)
