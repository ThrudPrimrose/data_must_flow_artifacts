...
@pytest.mark.skip
def test_program(program: str, device: dace.DeviceType, sdfg_name: str):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s',
                        ...
                        type=str,
                        nargs="?",
                        default='cloudsc_inner.sdfg',
                        help='The SDFG to use.')
    args = parser.parse_args()
    
    device = dace.DeviceType.GPU if args.target == 'gpu' else dace.DeviceType.CPU
    sdfg_name = args.sdfg_name

    test_program('cloudscexp2_inner', device, sdfg_name)