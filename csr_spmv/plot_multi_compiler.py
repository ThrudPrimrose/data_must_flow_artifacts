...
# ------------------------
paths = [
    ("gcc",  "amd_epyc",   "gcc/amd_epyc/csr_spmv_timings_1_core.csv"),
    ("gcc",  "intel_xeon", "gcc/intel_xeon/csr_spmv_timings_1_core.csv"),
    #("gcc",  "arm", "gcc/arm/csr_spmv_timings.csv"),
    ("llvm", "amd_epyc",   "llvm/amd_epyc/csr_spmv_timings_1_core.csv"),
    ("llvm", "intel_xeon", "llvm/intel_xeon/csr_spmv_timings_1_core.csv"),
    #("llvm", "arm", "llvm/arm/csr_spmv_timings.csv"),
]

for l, k, v in [("w_cpy", "csr_spmv_vectorized_static_veclen_8_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
             ("no_cpy", "csr_spmv_vectorized_static_veclen_8_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:


    label_map = {
        "csr_spmv": "Auto Vectorized",
        k: v, 
    }
    ...
    # SDFGs to include
    # ------------------------
    alt_name = base_name + k[len("csr_spmv"):]
