...
# ------------------------
paths = [
    ("gcc",  "amd_epyc",   "gcc/amd_epyc/TEMPLATE_timings_1_core.csv"),
    ("gcc",  "intel_xeon", "gcc/intel_xeon/TEMPLATE_timings_1_core.csv"),
    #("gcc",  "arm", "gcc/arm/TEMPLATE_timings.csv"),
    ("llvm", "amd_epyc",   "llvm/amd_epyc/TEMPLATE_timings_1_core.csv"),
    ("llvm", "intel_xeon", "llvm/intel_xeon/TEMPLATE_timings_1_core.csv"),
    #("llvm", "arm", "llvm/arm/TEMPLATE_timings.csv"),
]

for l, k, v in [("w_cpy", "TEMPLATE_vectorized_static_veclen_8_cpy", "Auto + DaCe Vectorized (veclen=8, expl. copy)"),
             ("no_cpy", "TEMPLATE_vectorized_static_veclen_8_no_cpy", "Auto + DaCe Vectorized (veclen=8, no. copy)")]:


    label_map = {
        "TEMPLATE": "Auto Vectorized",
        k: v, 
    }
    ...
    # SDFGs to include
    # ------------------------
    alt_name = base_name + k[len("TEMPLATE"):]
    ...
    color_map = {
    'TEMPLATE_std': colors[0],
    'TEMPLATE_std_vectorized_static_veclen_8_no_cpy': colors[1],
    'TEMPLATE_std_vectorized_static_veclen_8_cpy': colors[2],
    'TEMPLATE_std_vectorized_static_veclen_16_no_cpy': colors[3],
    'TEMPLATE_std_vectorized_static_veclen_16_cpy': colors[4],
    'TEMPLATE_std_vectorized_static_veclen_32_no_cpy': colors[5],
    'TEMPLATE_std_vectorized_static_veclen_32_cpy': colors[6],
    'TEMPLATE_dace_vectorized_static_veclen_8_no_cpy': colors[7],
    'TEMPLATE_dace_vectorized_static_veclen_8_cpy': colors[8],
    'TEMPLATE_dace_vectorized_static_veclen_16_no_cpy': colors[9],
    'TEMPLATE_dace_vectorized_static_veclen_16_cpy': colors[10],
    'TEMPLATE_dace_vectorized_static_veclen_32_no_cpy': colors[11],
    'TEMPLATE_dace_vectorized_static_veclen_32_cpy': colors[12],
    }
